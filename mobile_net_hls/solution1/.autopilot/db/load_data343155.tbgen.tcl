set moduleName load_data343155
...
set C_modelName {load_data343155}
...
set C_modelArgList {
	...
	{ outputs_offset_c int 18 regular {fifo 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "inputs", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "outputs_offset_c", "interface" : "fifo", "bitwidth" : 18, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ outputs_offset2 sc_in sc_lv 18 signal 45 } 
	{ outputs_offset_c_din sc_out sc_lv 18 signal 46 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outputs_offset_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "outputs_offset_c", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_copy_input_fmem2buff_4_fu_369", "Parent" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_copy_weight_fmem2buf_2_fu_382", "Parent" : "0",
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_copy_beta_fmem2buffe_1_fu_428", "Parent" : "0",
...
set Spec2ImplPortList { 
	...
	outputs_offset_c { ap_fifo {  { outputs_offset_c_din fifo_data 1 18 }  { outputs_offset_c_full_n fifo_status 0 1 }  { outputs_offset_c_write fifo_update 1 1 } } }
