...
set C_modelName {load_data.1158}
...
set C_modelArgList {
	...
	{ inputs_offset_c int 18 regular {fifo 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "inputs", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "inputs_offset_c", "interface" : "fifo", "bitwidth" : 18, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ inputs_offset_c_din sc_out sc_lv 18 signal 22 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "inputs_offset_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "inputs_offset_c", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_copy_input_fmem2buff_9_fu_284", "Parent" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_copy_weight_fmem2buf_7_fu_298", "Parent" : "0",
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_copy_beta_fmem2buffe_3_fu_327", "Parent" : "0",
...
set Spec2ImplPortList { 
	...
	inputs_offset_c { ap_fifo {  { inputs_offset_c_din fifo_data 1 18 }  { inputs_offset_c_full_n fifo_status 0 1 }  { inputs_offset_c_write fifo_update 1 1 } } }
