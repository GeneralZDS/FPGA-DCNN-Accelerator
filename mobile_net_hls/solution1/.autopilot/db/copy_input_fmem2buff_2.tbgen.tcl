set moduleName copy_input_fmem2buff_2
...
set C_modelName {copy_input_fmem2buff.2}
...
set C_modelArgList {
	...
	{ rLoops int 10 regular  }
	{ cLoops int 10 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "inputs", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "r", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "c", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "nLoops", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "rLoops", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "cLoops", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ input_buffer_V_din sc_out sc_lv 16 signal 2 } 
	{ input_buffer_V_full_n sc_in sc_logic 1 signal 2 } 
	{ input_buffer_V_write sc_out sc_logic 1 signal 2 } 
	{ n sc_in sc_lv 3 signal 3 } 
	{ r sc_in sc_lv 10 signal 4 } 
	{ c sc_in sc_lv 10 signal 5 } 
	{ nLoops sc_in sc_lv 2 signal 6 } 
	{ rLoops sc_in sc_lv 10 signal 7 } 
	{ cLoops sc_in sc_lv 10 signal 8 } 
	{ input_cntl_V_din sc_out sc_logic 1 signal 9 } 
	{ input_cntl_V_full_n sc_in sc_logic 1 signal 9 } 
	{ input_cntl_V_write sc_out sc_logic 1 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "r", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "r", "role": "default" }} , 
 	...
 	{ "name": "rLoops", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "rLoops", "role": "default" }} , 
 	{ "name": "cLoops", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "cLoops", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "61", "Max" : "1049"}
	, {"Name" : "Interval", "Min" : "61", "Max" : "1049"}
]}
...
set Spec2ImplPortList { 
	...
	r { ap_none {  { r in_data 0 10 } } }
	c { ap_none {  { c in_data 0 10 } } }
	nLoops { ap_none {  { nLoops in_data 0 2 } } }
	rLoops { ap_none {  { rLoops in_data 0 10 } } }
	cLoops { ap_none {  { cLoops in_data 0 10 } } }
