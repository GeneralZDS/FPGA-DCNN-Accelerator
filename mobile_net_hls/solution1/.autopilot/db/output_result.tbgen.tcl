...
set C_modelName {output_result}
set C_modelType { void 0 }
set C_modelArgList {
	{ outputs int 16 regular {axi_master 1}  }
	{ outputs_offset int 31 regular {fifo 0}  }
	{ outputs_offset_c int 10 regular {fifo 0}  }
	{ output_buffer_V int 16 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "outputs", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "outputs_offset_c", "interface" : "fifo", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "output_buffer_V", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ outputs_offset_c_dout sc_in sc_lv 10 signal 2 } 
	{ outputs_offset_c_empty_n sc_in sc_logic 1 signal 2 } 
	{ outputs_offset_c_read sc_out sc_logic 1 signal 2 } 
	{ output_buffer_V_dout sc_in sc_lv 16 signal 3 } 
	{ output_buffer_V_empty_n sc_in sc_logic 1 signal 3 } 
	{ output_buffer_V_read sc_out sc_logic 1 signal 3 } 
	{ result_buffer_V_dout sc_in sc_logic 1 signal 4 } 
	{ result_buffer_V_empty_n sc_in sc_logic 1 signal 4 } 
	{ result_buffer_V_read sc_out sc_logic 1 signal 4 } 
	{ result_n_V_dout sc_in sc_lv 32 signal 5 } 
	{ result_n_V_empty_n sc_in sc_logic 1 signal 5 } 
	{ result_n_V_read sc_out sc_logic 1 signal 5 } 
	{ result_r_V_dout sc_in sc_lv 32 signal 6 } 
	{ result_r_V_empty_n sc_in sc_logic 1 signal 6 } 
	{ result_r_V_read sc_out sc_logic 1 signal 6 } 
	{ result_c_V_dout sc_in sc_lv 32 signal 7 } 
	{ result_c_V_empty_n sc_in sc_logic 1 signal 7 } 
	{ result_c_V_read sc_out sc_logic 1 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outputs_offset_c_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "outputs_offset_c", "role": "dout" }} , 
 	...
 	{ "name": "output_buffer_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "output_buffer_V", "role": "dout" }} , 
 	{ "name": "output_buffer_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "output_buffer_V", "role": "empty_n" }} , 
 	{ "name": "output_buffer_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "output_buffer_V", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "output_buffer_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
...
set Spec2ImplPortList { 
	...
	outputs_offset_c { ap_fifo {  { outputs_offset_c_dout fifo_data 0 10 }  { outputs_offset_c_empty_n fifo_status 0 1 }  { outputs_offset_c_read fifo_update 1 1 } } }
	output_buffer_V { ap_fifo {  { output_buffer_V_dout fifo_data 0 16 }  { output_buffer_V_empty_n fifo_status 0 1 }  { output_buffer_V_read fifo_update 1 1 } } }
