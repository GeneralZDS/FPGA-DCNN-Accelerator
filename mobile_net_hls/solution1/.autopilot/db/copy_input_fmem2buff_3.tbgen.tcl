set moduleName copy_input_fmem2buff_3
...
set C_modelName {copy_input_fmem2buff.3}
...
set C_modelArgMapList {[ 
	{ "Name" : "inputs", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "cLoops", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ nLoops sc_in sc_lv 2 signal 7 } 
	{ rLoops sc_in sc_lv 6 signal 8 } 
	{ cLoops sc_in sc_lv 6 signal 9 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "cLoops", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "cLoops", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "45", "Max" : "869"}
	, {"Name" : "Interval", "Min" : "45", "Max" : "869"}
]}
...
set Spec2ImplPortList { 
	...
	cLoops { ap_none {  { cLoops in_data 0 6 } } }
