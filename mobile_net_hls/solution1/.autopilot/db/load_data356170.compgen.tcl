...
# FIFO definition:
set ID 2925
set FifoName fifo_w1_d1_A_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { inputs_offset1 { I 10 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { outputs_offset2 { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { outputs_offset_c_din { O 3 vector } outputs_offset_c_full_n { I 1 bit } outputs_offset_c_write { O 1 bit } } \
} "
}
