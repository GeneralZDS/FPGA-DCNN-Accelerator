set moduleName copy_input_fmem2buff_8
...
set C_modelName {copy_input_fmem2buff.8}
...
set C_modelArgList {
	...
	{ rLoops int 9 regular  }
	{ cLoops int 5 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "inputs", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "r", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "c", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "nLoops", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "rLoops", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "cLoops", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ r sc_in sc_lv 9 signal 5 } 
	{ c sc_in sc_lv 9 signal 6 } 
	{ nLoops sc_in sc_lv 6 signal 7 } 
	{ rLoops sc_in sc_lv 9 signal 8 } 
	{ cLoops sc_in sc_lv 5 signal 9 } 
	{ input_cntl_V_din sc_out sc_logic 1 signal 10 } 
	{ input_cntl_V_full_n sc_in sc_logic 1 signal 10 } 
	{ input_cntl_V_write sc_out sc_logic 1 signal 10 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "r", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "r", "role": "default" }} , 
 	{ "name": "c", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "c", "role": "default" }} , 
 	{ "name": "nLoops", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "nLoops", "role": "default" }} , 
 	{ "name": "rLoops", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "rLoops", "role": "default" }} , 
 	{ "name": "cLoops", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "cLoops", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	r { ap_none {  { r in_data 0 9 } } }
	c { ap_none {  { c in_data 0 9 } } }
	nLoops { ap_none {  { nLoops in_data 0 6 } } }
	rLoops { ap_none {  { rLoops in_data 0 9 } } }
	cLoops { ap_none {  { cLoops in_data 0 5 } } }
