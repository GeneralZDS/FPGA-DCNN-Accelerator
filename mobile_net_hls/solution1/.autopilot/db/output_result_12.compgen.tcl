...
eval "cg_default_interface_gen_dc { \
    id 2756 \
    name inputs_offset_c \
    type fifo \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_inputs_offset_c \
    op interface \
    ports { inputs_offset_c_dout { I 17 vector } inputs_offset_c_empty_n { I 1 bit } inputs_offset_c_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { output_buffer_0_V_dout { I 16 vector } output_buffer_0_V_empty_n { I 1 bit } output_buffer_0_V_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { output_buffer_1_V_dout { I 16 vector } output_buffer_1_V_empty_n { I 1 bit } output_buffer_1_V_read { O 1 bit } } \
} "
}
