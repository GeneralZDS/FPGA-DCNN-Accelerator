set moduleName copy_weight_fmem2buf_4
...
set C_modelName {copy_weight_fmem2buf.4}
...
set C_modelArgMapList {[ 
	{ "Name" : "weights", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "m", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
 	{ "Name" : "nLoops", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "mLoops", "interface" : "wire", "bitwidth" : 9, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m sc_in sc_lv 9 signal 19 } 
	{ nLoops sc_in sc_lv 2 signal 20 } 
	{ mLoops sc_in sc_lv 9 signal 21 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "m", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "m", "role": "default" }} , 
 	{ "name": "nLoops", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "nLoops", "role": "default" }} , 
 	{ "name": "mLoops", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "mLoops", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	m { ap_none {  { m in_data 0 9 } } }
	nLoops { ap_none {  { nLoops in_data 0 2 } } }
	mLoops { ap_none {  { mLoops in_data 0 9 } } }
