set moduleName output_result_12
...
set C_modelArgMapList {[ 
	{ "Name" : "outputs", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "inputs_offset_c", "interface" : "fifo", "bitwidth" : 17, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ inputs_offset_c_dout sc_in sc_lv 17 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "inputs_offset_c_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":17, "type": "signal", "bundle":{"name": "inputs_offset_c", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	...
	inputs_offset_c { ap_fifo {  { inputs_offset_c_dout fifo_data 0 17 }  { inputs_offset_c_empty_n fifo_status 0 1 }  { inputs_offset_c_read fifo_update 1 1 } } }
