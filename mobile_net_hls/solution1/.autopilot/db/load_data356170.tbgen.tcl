set moduleName load_data356170
...
set C_modelName {load_data356170}
...
set C_modelArgList {
	...
	{ outputs_offset_c int 3 regular {fifo 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "inputs", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "outputs_offset_c", "interface" : "fifo", "bitwidth" : 3, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ weight_buffer_V_din sc_out sc_lv 16 signal 8 } 
	{ weight_buffer_V_full_n sc_in sc_logic 1 signal 8 } 
	{ weight_buffer_V_write sc_out sc_logic 1 signal 8 } 
	{ beta_buffer_V_din sc_out sc_lv 16 signal 9 } 
	{ beta_buffer_V_full_n sc_in sc_logic 1 signal 9 } 
	{ beta_buffer_V_write sc_out sc_logic 1 signal 9 } 
	{ data_buffer_V_din sc_out sc_logic 1 signal 10 } 
	{ data_buffer_V_full_n sc_in sc_logic 1 signal 10 } 
	{ data_buffer_V_write sc_out sc_logic 1 signal 10 } 
	{ data_m_V_din sc_out sc_lv 32 signal 11 } 
	{ data_m_V_full_n sc_in sc_logic 1 signal 11 } 
	{ data_m_V_write sc_out sc_logic 1 signal 11 } 
	{ data_n_V_din sc_out sc_lv 32 signal 12 } 
	{ data_n_V_full_n sc_in sc_logic 1 signal 12 } 
	{ data_n_V_write sc_out sc_logic 1 signal 12 } 
	{ outputs_offset2 sc_in sc_lv 3 signal 13 } 
	{ outputs_offset_c_din sc_out sc_lv 3 signal 14 } 
	{ outputs_offset_c_full_n sc_in sc_logic 1 signal 14 } 
	{ outputs_offset_c_write sc_out sc_logic 1 signal 14 } 
	{ outputs_offset sc_in sc_lv 31 signal 15 } 
	{ outputs_offset_out_din sc_out sc_lv 31 signal 16 } 
	{ outputs_offset_out_full_n sc_in sc_logic 1 signal 16 } 
	{ outputs_offset_out_write sc_out sc_logic 1 signal 16 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outputs_offset_c_din", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "outputs_offset_c", "role": "din" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6"],
		...
		"Port" : [
			{"Name" : "inputs", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_copy_input_fmem2buff_fu_281", "Port" : "inputs"}]},
			{"Name" : "inputs_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "inputs_offset1", "Type" : "None", "Direction" : "I"},
			{"Name" : "weights", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_copy_weight_fmem2buf_fu_268", "Port" : "weights"}]},
			{"Name" : "weights_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "betas", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_copy_beta_fmem2buffe_fu_295", "Port" : "betas"}]},
			{"Name" : "betas_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "input_buffer_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "grp_copy_input_fmem2buff_fu_281", "Port" : "input_buffer_V"}]},
			{"Name" : "weight_buffer_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_copy_weight_fmem2buf_fu_268", "Port" : "weight_buffer_V"}]},
			{"Name" : "beta_buffer_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_copy_beta_fmem2buffe_fu_295", "Port" : "beta_buffer_V"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_copy_weight_fmem2buf_fu_268", "Parent" : "0",
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_copy_input_fmem2buff_fu_281", "Parent" : "0",
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_copy_beta_fmem2buffe_fu_295", "Parent" : "0",
...
set Spec2ImplPortList { 
	...
	outputs_offset_c { ap_fifo {  { outputs_offset_c_din fifo_data 1 3 }  { outputs_offset_c_full_n fifo_status 0 1 }  { outputs_offset_c_write fifo_update 1 1 } } }
