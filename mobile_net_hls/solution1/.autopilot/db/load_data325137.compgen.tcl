...
# FIFO definition:
set ID 673
set FifoName fifo_w1_d1_A_x_x_x_x
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { inputs_offset1 { I 20 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { outputs_offset2 { I 21 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { outputs_offset_c_din { O 21 vector } outputs_offset_c_full_n { I 1 bit } outputs_offset_c_write { O 1 bit } } \
} "
}
