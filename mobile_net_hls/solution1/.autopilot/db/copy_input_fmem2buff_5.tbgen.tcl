set moduleName copy_input_fmem2buff_5
...
set C_modelName {copy_input_fmem2buff.5}
...
set C_modelArgMapList {[ 
	{ "Name" : "inputs", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "cLoops", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "cLoops", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "cLoops", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	cLoops { ap_none {  { cLoops in_data 0 8 } } }
