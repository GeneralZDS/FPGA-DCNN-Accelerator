set moduleName copy_beta_fmem2buffe
...
set C_modelName {copy_beta_fmem2buffe}
...
set portList { 
	...
	{ beta_cntl_V_din sc_out sc_logic 1 signal 4 } 
	{ beta_cntl_V_full_n sc_in sc_logic 1 signal 4 } 
	{ beta_cntl_V_write sc_out sc_logic 1 signal 4 } 
}
set NewPortList {[ 
