set moduleName output_result_10
...
set C_modelArgMapList {[ 
	{ "Name" : "outputs", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "outputs_offset_c", "interface" : "fifo", "bitwidth" : 20, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ outputs_offset_c_dout sc_in sc_lv 20 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outputs_offset_c_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":20, "type": "signal", "bundle":{"name": "outputs_offset_c", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	...
	outputs_offset_c { ap_fifo {  { outputs_offset_c_dout fifo_data 0 20 }  { outputs_offset_c_empty_n fifo_status 0 1 }  { outputs_offset_c_read fifo_update 1 1 } } }
