set moduleName copy_weight_fmem2buf_6
...
set C_modelName {copy_weight_fmem2buf.6}
...
set portList { 
	...
	{ n sc_in sc_lv 7 signal 11 } 
	{ r sc_in sc_lv 8 signal 12 } 
	{ c sc_in sc_lv 8 signal 13 } 
	{ nLoops sc_in sc_lv 7 signal 14 } 
