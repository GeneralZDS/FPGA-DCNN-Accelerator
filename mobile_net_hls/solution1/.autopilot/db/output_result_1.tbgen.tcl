set moduleName output_result_1
...
set C_modelArgMapList {[ 
	{ "Name" : "outputs", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "outputs_offset_c", "interface" : "fifo", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ outputs_offset_c_dout sc_in sc_lv 3 signal 2 } 
	...
	{ result_m_V_dout sc_in sc_lv 32 signal 5 } 
	{ result_m_V_empty_n sc_in sc_logic 1 signal 5 } 
	{ result_m_V_read sc_out sc_logic 1 signal 5 } 
	{ result_n_V_dout sc_in sc_lv 32 signal 6 } 
	{ result_n_V_empty_n sc_in sc_logic 1 signal 6 } 
	{ result_n_V_read sc_out sc_logic 1 signal 6 } 
	{ cntl_V_din sc_out sc_logic 1 signal 7 } 
	{ cntl_V_full_n sc_in sc_logic 1 signal 7 } 
	{ cntl_V_write sc_out sc_logic 1 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "outputs_offset_c_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "outputs_offset_c", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	...
	outputs_offset_c { ap_fifo {  { outputs_offset_c_dout fifo_data 0 3 }  { outputs_offset_c_empty_n fifo_status 0 1 }  { outputs_offset_c_read fifo_update 1 1 } } }
