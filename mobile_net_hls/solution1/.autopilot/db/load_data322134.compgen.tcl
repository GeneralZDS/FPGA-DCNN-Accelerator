...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { inputs_offset1 { I 22 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { outputs_offset2 { I 20 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { outputs_offset_c_din { O 20 vector } outputs_offset_c_full_n { I 1 bit } outputs_offset_c_write { O 1 bit } } \
} "
}
