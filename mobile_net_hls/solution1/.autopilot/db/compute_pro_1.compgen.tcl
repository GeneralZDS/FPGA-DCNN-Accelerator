...
set ID 2947
set hasByteEnable 0
set MemName compute_pro_1_inpcmv
...
set ID 2948
set hasByteEnable 0
set MemName compute_pro_1_outcnw
set CoreName ap_simcore_mem
set PortList { 1 0 }
set DataWd 16
set AddrRange 4
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { weight_buffer_V_dout { I 16 vector } weight_buffer_V_empty_n { I 1 bit } weight_buffer_V_read { O 1 bit } } \
} "
}
