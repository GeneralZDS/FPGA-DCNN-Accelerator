set moduleName copy_weight_fmem2buf_1
...
set C_modelName {copy_weight_fmem2buf.1}
...
set C_modelArgMapList {[ 
	{ "Name" : "weights", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "mLoops", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ n sc_in sc_lv 6 signal 18 } 
	{ m sc_in sc_lv 7 signal 19 } 
	{ nLoops sc_in sc_lv 2 signal 20 } 
	{ mLoops sc_in sc_lv 7 signal 21 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mLoops", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "mLoops", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	mLoops { ap_none {  { mLoops in_data 0 7 } } }
