...
set id 2845
set name moblie_net_sptohpciv
set corename simcore_sptohp
set op sptohp
set stage_num 3
set max_latency -1
set registered_input 1
...
set dout_width 16
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_sptohp] == "ap_gen_simcore_sptohp"} {
eval "ap_gen_simcore_sptohp { \
    id ${id} \
    name ${name} \
    corename ${corename} \
    op ${op} \
...
puts "@W \[IMPL-100\] Cannot find ap_gen_simcore_sptohp, check your AutoPilot builtin lib"
}
}
...
set ID 2852
set hasByteEnable 0
set MemName compute_pro_outpucgu
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { output_buffer_V_din { O 16 vector } output_buffer_V_full_n { I 1 bit } output_buffer_V_write { O 1 bit } } \
} "
}
