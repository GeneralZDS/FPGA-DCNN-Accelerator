set moduleName copy_beta_fmem2buffe_2
...
set C_modelName {copy_beta_fmem2buffe.2}
...
set portList { 
	...
	{ n sc_in sc_lv 7 signal 3 } 
	{ r sc_in sc_lv 8 signal 4 } 
	{ c sc_in sc_lv 8 signal 5 } 
	{ nLoops sc_in sc_lv 7 signal 6 } 
