...
reg   [0:0] exitcond_reg_161_pp0_iter1_reg;
wire   [2:0] i_3_fu_145_p2;
reg    ap_enable_reg_pp0_iter0;
reg   [15:0] tmp_639_reg_170;
wire    ap_CS_fsm_state7;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state8;
reg    ap_enable_reg_pp0_iter2;
wire   [63:0] tmp_178_fu_122_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((tmp_fu_133_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        i_reg_111 <= 3'd0;
    end else if (((exitcond_fu_139_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_reg_161 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_639_reg_170 <= m_axi_betas_RDATA;
    end
end

always @ (*) begin
    if ((exitcond_fu_139_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((exitcond_reg_161_pp0_iter1_reg == 1'd0) & (beta_buffer_V_full_n == 1'b1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((tmp_fu_133_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
...
always @ (*) begin
    if (((exitcond_reg_161 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((tmp_fu_133_p2 == 1'd1) & (ap_reg_ioackin_m_axi_betas_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
...
always @ (*) begin
    if (((exitcond_reg_161 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if ((~((ap_start == 1'b0) | (1'b1 == ap_block_state1_io)) & (tmp_fu_133_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
                ap_NS_fsm = ap_ST_fsm_state11;
            end else if ((~((ap_start == 1'b0) | (1'b1 == ap_block_state1_io)) & (tmp_fu_133_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((exitcond_fu_139_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((exitcond_fu_139_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_state11;
            end else begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond_reg_161 == 1'd0) & (m_axi_betas_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((exitcond_reg_161 == 1'd0) & (m_axi_betas_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((exitcond_reg_161 == 1'd0) & (m_axi_betas_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state10_pp0_stage0_iter2 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state1_io = ((tmp_fu_133_p2 == 1'd1) & (ap_sig_ioackin_m_axi_betas_ARREADY == 1'b0));
end

assign ap_block_state8_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state9_pp0_stage0_iter1 = ((exitcond_reg_161 == 1'd0) & (m_axi_betas_RVALID == 1'b0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign beta_buffer_V_din = tmp_639_reg_170;

assign beta_cntl_V_din = 1'd0;

assign exitcond_fu_139_p2 = ((i_reg_111 == 3'd4) ? 1'b1 : 1'b0);

assign i_3_fu_145_p2 = (i_reg_111 + 3'd1);

assign m_axi_betas_ARADDR = tmp_178_fu_122_p1;
...
assign tmp_178_fu_122_p1 = betas_offset;

assign tmp_fu_133_p2 = ((n == 10'd0) ? 1'b1 : 1'b0);

endmodule //copy_beta_fmem2buffe
