...
wire   [0:0] tmp_632_i_i_i_fu_587_p2;
wire   [0:0] tmp_268_fu_602_p1;
...
reg   [31:0] tmp_265_reg_697;
wire    ap_CS_fsm_state3;
wire   [0:0] tmp_nbreadreq_fu_140_p3;
reg   [31:0] tmp_266_reg_702;
reg   [31:0] tmp_267_reg_708;
reg   [0:0] tmp_257_reg_714;
reg   [24:0] tmp_144_i_i_reg_719;
reg   [0:0] tmp_258_reg_724;
reg   [30:0] p_lshr7_i_i_i_reg_729;
reg   [30:0] p_lshr_f6_i_i_i_reg_734;
wire   [31:0] nLoops_fu_376_p3;
reg   [31:0] nLoops_reg_739;
wire    ap_CS_fsm_state4;
wire   [31:0] base_addr_fu_449_p2;
wire   [31:0] tmp_630_i_i_i_fu_511_p3;
reg   [31:0] tmp_630_i_i_i_reg_749;
wire   [31:0] tmp_631_i_i_i_fu_575_p3;
reg   [31:0] tmp_631_i_i_i_reg_754;
wire   [1:0] tn_fu_592_p2;
reg   [1:0] tn_reg_763;
reg    ap_predicate_op108_write_state5;
reg    ap_block_state5;
wire   [0:0] tmp_261_fu_598_p1;
reg   [0:0] tmp_261_reg_768;
wire   [30:0] tr_divS_fu_615_p2;
reg   [30:0] tr_divS_reg_778;
wire    ap_CS_fsm_state6;
reg   [31:0] outputs_addr_reg_783;
wire   [0:0] tmp_633_i_i_i_fu_610_p2;
wire   [31:0] base_addr_d1_12_fu_649_p2;
wire   [0:0] tmp_635_i_i_i_fu_659_p2;
...
wire   [31:0] base_addr_d2_12_fu_678_p2;
reg   [31:0] base_addr_d2_12_reg_813;
...
wire   [15:0] ap_phi_reg_pp0_iter0_tmp_154_load_i_i_reg_261;
reg   [15:0] ap_phi_reg_pp0_iter1_tmp_154_load_i_i_reg_261;
...
wire   [31:0] p_neg7_i_i_i_fu_317_p2;
wire   [31:0] tmp_i_i_i_fu_343_p2;
wire   [31:0] tmp_621_i_i_i_fu_354_p2;
wire   [31:0] tmp_623_i_i_i_fu_365_p2;
wire   [0:0] tmp_624_i_i_i_fu_370_p2;
wire   [31:0] p_neg6_i_i_i_fu_389_p2;
wire   [24:0] tmp_960_i_i_i_fu_394_p4;
wire   [24:0] tmp_961_i_i_i_fu_404_p2;
wire   [24:0] tmp_145_i_i_fu_410_p3;
wire   [31:0] tmp_146_i_i_fu_424_p1;
wire   [31:0] p_neg_t3_i_i_i_fu_427_p2;
wire   [31:0] tmp_147_i_i_fu_433_p1;
wire   [31:0] tmp_256_fu_384_p2;
wire   [31:0] tmp_628_i_i_i_fu_436_p3;
wire   [31:0] tmp1_i_i_fu_443_p2;
wire   [31:0] tmp_627_i_i_i_fu_416_p3;
wire   [31:0] p_neg4_i_i_i_fu_463_p2;
wire   [30:0] p_lshr5_i_i_i_fu_469_p4;
wire   [31:0] tmp_148_i_i_fu_479_p1;
wire   [30:0] p_lshr_f7_i_i_i_fu_489_p4;
wire   [0:0] tmp_259_fu_455_p3;
wire   [31:0] p_neg_t6_i_i_i_fu_483_p2;
wire   [31:0] tmp_149_i_i_fu_499_p1;
wire   [0:0] tmp_622_i_i_i_fu_359_p2;
wire   [31:0] p_op_i_i_i_fu_503_p3;
wire   [31:0] p_neg_i_i_i_fu_527_p2;
wire   [30:0] p_lshr_i_i_i_fu_533_p4;
wire   [31:0] tmp_150_i_i_fu_543_p1;
wire   [30:0] p_lshr_f_i_i_i_fu_553_p4;
wire   [0:0] tmp_260_fu_519_p3;
wire   [31:0] p_neg_t_i_i_i_fu_547_p2;
wire   [31:0] tmp_151_i_i_fu_563_p1;
wire   [0:0] tmp_620_i_i_i_fu_348_p2;
...
wire   [32:0] tmp_37_i_i_fu_625_p2;
wire  signed [33:0] tmp_37_cast_i_i_fu_630_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_predicate_op108_write_state5 == 1'b1) & (cntl_V_full_n == 1'b0)) & (tmp_268_fu_602_p1 == 1'd0) & (tmp_632_i_i_i_fu_587_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_273)) begin
        if (((tmp_261_reg_768 == 1'd0) & (tmp_635_i_i_i_fu_659_p2 == 1'd1))) begin
            ap_phi_reg_pp0_iter1_tmp_154_load_i_i_reg_261 <= output_buffer_0_V_dout;
        end else if (((tmp_635_i_i_i_fu_659_p2 == 1'd1) & (tmp_261_reg_768 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((ap_predicate_op108_write_state5 == 1'b1) & (cntl_V_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state5) & (tmp_632_i_i_i_fu_587_p2 == 1'd1))) begin
        base_addr_d2_0_i_i_i_reg_228 <= base_addr_d2_reg_207;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_633_i_i_i_fu_610_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state6))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_635_i_i_i_fu_659_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state6) & (tmp_633_i_i_i_fu_610_p2 == 1'd1))) begin
        outputs_addr_reg_783 <= sum_cast_i_i_fu_639_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((~((outputs_offset_c_empty_n == 1'b0) | (outputs_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        outputs_offset_cast_s_reg_684[19 : 0] <= outputs_offset_cast_s_fu_271_p1[19 : 0];
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (tmp_nbreadreq_fu_140_p3 == 1'd1))) begin
        p_lshr7_i_i_i_reg_729 <= {{p_neg7_i_i_i_fu_317_p2[31:1]}};
        p_lshr_f6_i_i_i_reg_734 <= {{result_c_V_dout[31:1]}};
        tmp_144_i_i_reg_719 <= {{result_r_V_dout[25:1]}};
        tmp_257_reg_714 <= result_r_V_dout[32'd31];
        tmp_258_reg_724 <= result_c_V_dout[32'd31];
...
always @ (posedge ap_clk) begin
    if ((~((ap_predicate_op108_write_state5 == 1'b1) & (cntl_V_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state5) & (tmp_632_i_i_i_fu_587_p2 == 1'd1))) begin
...
always @ (*) begin
    if ((tmp_635_i_i_i_fu_659_p2 == 1'd0)) begin
...
always @ (*) begin
    if ((~((ap_predicate_op108_write_state5 == 1'b1) & (cntl_V_full_n == 1'b0)) & (tmp_268_fu_602_p1 == 1'd0) & (tmp_632_i_i_i_fu_587_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((tmp_268_fu_602_p1 == 1'd0) & (tmp_632_i_i_i_fu_587_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_01001) & (ap_reg_ioackin_m_axi_outputs_WREADY == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_635_i_i_i_reg_794 == 1'd1))) begin
...
always @ (*) begin
    if (((tmp_261_reg_768 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (output_buffer_0_V_empty_n == 1'b1) & (tmp_635_i_i_i_fu_659_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (output_buffer_1_V_empty_n == 1'b1) & (tmp_635_i_i_i_fu_659_p2 == 1'd1) & (tmp_261_reg_768 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_635_i_i_i_reg_794 == 1'd1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if ((~((ap_predicate_op108_write_state5 == 1'b1) & (cntl_V_full_n == 1'b0)) & (tmp_632_i_i_i_fu_587_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5) & (result_buffer_V_empty_n == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state5 : begin
            if ((~((ap_predicate_op108_write_state5 == 1'b1) & (cntl_V_full_n == 1'b0)) & (tmp_268_fu_602_p1 == 1'd0) & (tmp_632_i_i_i_fu_587_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~((ap_predicate_op108_write_state5 == 1'b1) & (cntl_V_full_n == 1'b0)) & (tmp_632_i_i_i_fu_587_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state5) & (tmp_268_fu_602_p1 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if ((~((ap_predicate_op108_write_state5 == 1'b1) & (cntl_V_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state5) & (tmp_632_i_i_i_fu_587_p2 == 1'd1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((tmp_635_i_i_i_fu_659_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((tmp_635_i_i_i_fu_659_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    ap_block_state9_io = ((ap_sig_ioackin_m_axi_outputs_WREADY == 1'b0) & (tmp_635_i_i_i_reg_794 == 1'd1));
end
...
always @ (*) begin
    ap_condition_699 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_635_i_i_i_reg_794 == 1'd1));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign ap_phi_reg_pp0_iter0_tmp_154_load_i_i_reg_261 = 'bx;

always @ (*) begin
    ap_predicate_op108_write_state5 = ((tmp_268_fu_602_p1 == 1'd0) & (tmp_632_i_i_i_fu_587_p2 == 1'd0));
end

assign base_addr_d1_12_fu_649_p2 = (base_addr_d2_reg_207 + 32'd16384);

assign base_addr_d2_12_fu_678_p2 = ($signed(base_addr_d2_0_i_i_i_reg_228) + $signed(32'd128));

assign base_addr_fu_449_p2 = (tmp1_i_i_fu_443_p2 + tmp_627_i_i_i_fu_416_p3);
...
assign m_axi_outputs_AWADDR = outputs_addr_reg_783;
...
assign m_axi_outputs_AWLEN = tmp_631_i_i_i_reg_754;
...
assign m_axi_outputs_WDATA = ap_phi_reg_pp0_iter1_tmp_154_load_i_i_reg_261;
...
assign nLoops_fu_376_p3 = ((tmp_624_i_i_i_fu_370_p2[0:0] === 1'b1) ? 32'd2 : tmp_623_i_i_i_fu_365_p2);

assign outputs_offset_cast_s_fu_271_p1 = outputs_offset_c_dout;

assign p_lshr5_i_i_i_fu_469_p4 = {{p_neg4_i_i_i_fu_463_p2[31:1]}};

assign p_lshr_f7_i_i_i_fu_489_p4 = {{tmp_621_i_i_i_fu_354_p2[31:1]}};

assign p_lshr_f_i_i_i_fu_553_p4 = {{tmp_i_i_i_fu_343_p2[31:1]}};

assign p_lshr_i_i_i_fu_533_p4 = {{p_neg_i_i_i_fu_527_p2[31:1]}};

assign p_neg4_i_i_i_fu_463_p2 = (32'd0 - tmp_621_i_i_i_fu_354_p2);

assign p_neg6_i_i_i_fu_389_p2 = (32'd0 - tmp_266_reg_702);

assign p_neg7_i_i_i_fu_317_p2 = (32'd0 - result_c_V_dout);

assign p_neg_i_i_i_fu_527_p2 = (32'd0 - tmp_i_i_i_fu_343_p2);

assign p_neg_t3_i_i_i_fu_427_p2 = (32'd0 - tmp_146_i_i_fu_424_p1);

assign p_neg_t6_i_i_i_fu_483_p2 = (32'd0 - tmp_148_i_i_fu_479_p1);

assign p_neg_t_i_i_i_fu_547_p2 = (32'd0 - tmp_150_i_i_fu_543_p1);

assign p_op2_i_i_i_fu_567_p3 = ((tmp_260_fu_519_p3[0:0] === 1'b1) ? p_neg_t_i_i_i_fu_547_p2 : tmp_151_i_i_fu_563_p1);

assign p_op_i_i_i_fu_503_p3 = ((tmp_259_fu_455_p3[0:0] === 1'b1) ? p_neg_t6_i_i_i_fu_483_p2 : tmp_149_i_i_fu_499_p1);

assign sext_cast_i_i_fu_275_p1 = outputs_offset_dout;

assign sum_cast_i_i_fu_639_p1 = $signed(sum_i_i_fu_634_p2);

assign sum_i_i_fu_634_p2 = ($signed(sext_cast_i_i_reg_689) + $signed(tmp_37_cast_i_i_fu_630_p1));

assign tmp1_i_i_fu_443_p2 = (tmp_256_fu_384_p2 + tmp_628_i_i_i_fu_436_p3);

assign tmp_145_i_i_fu_410_p3 = ((tmp_257_reg_714[0:0] === 1'b1) ? tmp_961_i_i_i_fu_404_p2 : tmp_144_i_i_reg_719);

assign tmp_146_i_i_fu_424_p1 = p_lshr7_i_i_i_reg_729;

assign tmp_147_i_i_fu_433_p1 = p_lshr_f6_i_i_i_reg_734;

assign tmp_148_i_i_fu_479_p1 = p_lshr5_i_i_i_fu_469_p4;

assign tmp_149_i_i_fu_499_p1 = p_lshr_f7_i_i_i_fu_489_p4;

assign tmp_150_i_i_fu_543_p1 = p_lshr_i_i_i_fu_533_p4;

assign tmp_151_i_i_fu_563_p1 = p_lshr_f_i_i_i_fu_553_p4;

assign tmp_256_fu_384_p2 = tmp_267_reg_708 << 32'd14;

assign tmp_259_fu_455_p3 = tmp_621_i_i_i_fu_354_p2[32'd31];

assign tmp_260_fu_519_p3 = tmp_i_i_i_fu_343_p2[32'd31];

assign tmp_261_fu_598_p1 = tn_0_i_i_i_i_reg_217[0:0];

assign tmp_268_fu_602_p1 = result_buffer_V_dout;

assign tmp_37_cast_i_i_fu_630_p1 = $signed(tmp_37_i_i_fu_625_p2);

assign tmp_37_i_i_fu_625_p2 = ($signed(outputs_offset_cast_s_reg_684) + $signed(tmp_cast_i_i_fu_621_p1));

assign tmp_620_i_i_i_fu_348_p2 = (($signed(tmp_i_i_i_fu_343_p2) > $signed(32'd16)) ? 1'b1 : 1'b0);

assign tmp_621_i_i_i_fu_354_p2 = (32'd256 - tmp_266_reg_702);

assign tmp_622_i_i_i_fu_359_p2 = (($signed(tmp_621_i_i_i_fu_354_p2) > $signed(32'd16)) ? 1'b1 : 1'b0);

assign tmp_623_i_i_i_fu_365_p2 = (32'd32 - tmp_267_reg_708);

assign tmp_624_i_i_i_fu_370_p2 = (($signed(tmp_623_i_i_i_fu_365_p2) > $signed(32'd2)) ? 1'b1 : 1'b0);

assign tmp_627_i_i_i_fu_416_p3 = {{tmp_145_i_i_fu_410_p3}, {7'd0}};

assign tmp_628_i_i_i_fu_436_p3 = ((tmp_258_reg_724[0:0] === 1'b1) ? p_neg_t3_i_i_i_fu_427_p2 : tmp_147_i_i_fu_433_p1);

assign tmp_630_i_i_i_fu_511_p3 = ((tmp_622_i_i_i_fu_359_p2[0:0] === 1'b1) ? 32'd8 : p_op_i_i_i_fu_503_p3);

assign tmp_631_i_i_i_fu_575_p3 = ((tmp_620_i_i_i_fu_348_p2[0:0] === 1'b1) ? 32'd8 : p_op2_i_i_i_fu_567_p3);

assign tmp_632_i_i_i_fu_587_p2 = (($signed(tn_0_i_cast_i_i_i_fu_583_p1) < $signed(nLoops_reg_739)) ? 1'b1 : 1'b0);

assign tmp_633_i_i_i_fu_610_p2 = (($signed(tr_divS_0_i_cast_i_i_fu_606_p1) < $signed(tmp_630_i_i_i_reg_749)) ? 1'b1 : 1'b0);

assign tmp_635_i_i_i_fu_659_p2 = (($signed(i_0_i_cast_i_i_i_fu_655_p1) < $signed(tmp_631_i_i_i_reg_754)) ? 1'b1 : 1'b0);

assign tmp_960_i_i_i_fu_394_p4 = {{p_neg6_i_i_i_fu_389_p2[25:1]}};

assign tmp_961_i_i_i_fu_404_p2 = (25'd0 - tmp_960_i_i_i_fu_394_p4);

assign tmp_cast_i_i_fu_621_p1 = base_addr_d2_0_i_i_i_reg_228;

assign tmp_i_i_i_fu_343_p2 = (32'd256 - tmp_265_reg_697);
...
always @ (posedge ap_clk) begin
    outputs_offset_cast_s_reg_684[32:20] <= 13'b0000000000000;
    sext_cast_i_i_reg_689[33:31] <= 3'b000;
end

endmodule //output_result_10
