...
wire   [11:0] base_addr1_fu_284_p2;
wire   [0:0] tmp_533_fu_296_p2;
reg   [0:0] tmp_533_reg_368;
wire   [2:0] tmp_534_fu_302_p1;
reg   [2:0] tmp_534_reg_372;
wire   [1:0] tn_1_fu_315_p2;
reg   [1:0] tn_1_reg_380;
wire    ap_CS_fsm_state2;
reg   [31:0] weights_addr_reg_385;
wire   [0:0] tmp_s_fu_310_p2;
wire   [0:0] exitcond_fu_340_p2;
reg   [0:0] exitcond_reg_391;
wire   [3:0] i_1_fu_346_p2;
reg   [3:0] i_1_reg_395;
reg    ap_enable_reg_pp0_iter0;
reg   [15:0] tmp_535_reg_400;
wire   [11:0] base_addr1_d1_1_fu_352_p2;
wire    ap_CS_fsm_state13;
wire    ap_CS_fsm_state9;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state10;
reg    ap_enable_reg_pp0_iter2;
reg   [11:0] base_addr1_d_reg_235;
reg   [1:0] tn_reg_245;
...
wire   [11:0] p_shl_fu_276_p3;
wire   [11:0] n_cast3_fu_272_p1;
wire   [5:0] tmp_fu_290_p2;
wire   [2:0] tn_cast_cast_fu_306_p1;
wire   [31:0] tmp_148_cast_fu_321_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (tmp_533_fu_296_p2 == 1'd1) & (ap_start == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_533_reg_368 == 1'd1))) begin
        tn_1_reg_380 <= tn_1_fu_315_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_s_fu_310_p2 == 1'd1) & (tmp_533_reg_368 == 1'd1))) begin
...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | ((1'b1 == ap_CS_fsm_state2) & ((tmp_s_fu_310_p2 == 1'd0) | (tmp_533_reg_368 == 1'd0))))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & ((tmp_s_fu_310_p2 == 1'd0) | (tmp_533_reg_368 == 1'd0)))) begin
        ap_ready = 1'b1;
    end else begin
        ap_ready = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (weight_cntl_V_full_n == 1'b1) & ((tmp_s_fu_310_p2 == 1'd0) | (tmp_533_reg_368 == 1'd0)))) begin
...
assign base_addr1_d1_1_fu_352_p2 = (base_addr1_d_reg_235 + 12'd9);
...
assign i_1_fu_346_p2 = (ap_phi_mux_i_phi_fu_260_p4 + 4'd1);
...
assign sum_fu_325_p2 = (weights_offset_cast_reg_358 + tmp_148_cast_fu_321_p1);

assign tmp_148_cast_fu_321_p1 = base_addr1_d_reg_235;

assign tmp_533_fu_296_p2 = ((tmp_fu_290_p2 == 6'd0) ? 1'b1 : 1'b0);

assign tmp_534_fu_302_p1 = nLoops[2:0];

assign tmp_fu_290_p2 = (r | c);

assign tmp_s_fu_310_p2 = (($signed(tn_cast_cast_fu_306_p1) < $signed(tmp_534_reg_372)) ? 1'b1 : 1'b0);

assign tn_1_fu_315_p2 = (tn_reg_245 + 2'd1);

assign tn_cast_cast_fu_306_p1 = tn_reg_245;

assign weight_buffer_0_V_din = tmp_535_reg_400;

assign weight_buffer_1_V_din = tmp_535_reg_400;

assign weight_buffer_2_V_din = tmp_535_reg_400;

assign weight_buffer_3_V_din = tmp_535_reg_400;

assign weight_buffer_4_V_din = tmp_535_reg_400;

assign weight_buffer_5_V_din = tmp_535_reg_400;

assign weight_buffer_6_V_din = tmp_535_reg_400;

assign weight_buffer_7_V_din = tmp_535_reg_400;

assign weight_buffer_8_V_din = tmp_535_reg_400;
...
endmodule //copy_weight_fmem2buf_9
