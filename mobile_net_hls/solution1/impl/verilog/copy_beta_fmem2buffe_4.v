...
reg   [0:0] tmp_172_reg_229;
reg   [1:0] i_reg_138;
wire   [0:0] tmp_629_fu_159_p2;
wire   [2:0] tmp_630_fu_169_p1;
reg   [2:0] tmp_630_reg_212;
reg   [31:0] betas_addr_reg_218;
reg    ap_sig_ioackin_m_axi_betas_ARREADY;
wire   [0:0] tmp_172_fu_197_p2;
wire    ap_block_state9_pp0_stage0_iter0;
reg    ap_block_state10_pp0_stage0_iter1;
wire    ap_block_state11_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_11001;
reg   [0:0] tmp_172_reg_229_pp0_iter1_reg;
wire   [1:0] i_24_fu_202_p2;
reg    ap_enable_reg_pp0_iter0;
reg   [15:0] tmp_631_reg_238;
...
wire   [8:0] tmp_fu_153_p2;
wire   [31:0] betas_offset_cast_fu_149_p1;
wire   [31:0] tmp_286_cast_fu_165_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        i_reg_138 <= 2'd0;
    end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (tmp_172_fu_197_p2 == 1'd1))) begin
        i_reg_138 <= i_24_fu_202_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1) & (tmp_629_fu_159_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (tmp_172_reg_229 == 1'd1))) begin
        tmp_631_reg_238 <= m_axi_betas_RDATA;
    end
end

always @ (*) begin
    if ((tmp_172_fu_197_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((beta_buffer_V_full_n == 1'b1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (tmp_172_reg_229_pp0_iter1_reg == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_172_reg_229 == 1'd1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (tmp_172_reg_229 == 1'd1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if (((tmp_629_fu_159_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_state12;
            end else if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1) & (tmp_629_fu_159_p2 == 1'd1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((tmp_172_fu_197_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((tmp_172_fu_197_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_state12;
            end else begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((m_axi_betas_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_172_reg_229 == 1'd1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_betas_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_172_reg_229 == 1'd1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_betas_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_172_reg_229 == 1'd1));
end

always @ (*) begin
    ap_block_state10_pp0_stage0_iter1 = ((m_axi_betas_RVALID == 1'b0) & (tmp_172_reg_229 == 1'd1));
end
...
assign beta_buffer_V_din = tmp_631_reg_238;

assign beta_cntl_V_din = 1'd0;

assign betas_offset_cast_fu_149_p1 = betas_offset;

assign i_24_fu_202_p2 = (i_reg_138 + 2'd1);
...
assign m_axi_betas_ARLEN = tmp_630_reg_212;
...
assign sum_fu_173_p2 = (betas_offset_cast_fu_149_p1 + tmp_286_cast_fu_165_p1);

assign tmp_172_fu_197_p2 = (($signed(i_cast_cast_fu_193_p1) < $signed(tmp_630_reg_212)) ? 1'b1 : 1'b0);

assign tmp_286_cast_fu_165_p1 = n;

assign tmp_629_fu_159_p2 = ((tmp_fu_153_p2 == 9'd0) ? 1'b1 : 1'b0);

assign tmp_630_fu_169_p1 = nLoops[2:0];

assign tmp_fu_153_p2 = (r | c);

endmodule //copy_beta_fmem2buffe_4
