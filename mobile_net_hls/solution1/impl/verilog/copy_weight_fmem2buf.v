...
reg   [5:0] i_reg_149;
wire   [31:0] weights_offset_cast_fu_160_p1;
reg   [31:0] weights_offset_cast_reg_225;
wire   [11:0] n_cast_cast_fu_164_p1;
wire   [31:0] tmp_s_fu_168_p1;
reg   [31:0] tmp_s_reg_235;
wire   [2:0] tm_1_fu_178_p2;
...
wire   [31:0] tmp_65_cast_fu_184_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        tmp_s_reg_235[5 : 0] <= tmp_s_fu_168_p1[5 : 0];
        weights_offset_cast_reg_225[30 : 0] <= weights_offset_cast_fu_160_p1[30 : 0];
    end
end
...
assign m_axi_weights_ARLEN = tmp_s_reg_235;
...
assign n_cast_cast_fu_164_p1 = n;

assign sum_cast_fu_193_p1 = sum_fu_188_p2;

assign sum_fu_188_p2 = (weights_offset_cast_reg_225 + tmp_65_cast_fu_184_p1);

assign tm_1_fu_178_p2 = (tm_reg_138 + 3'd1);

assign tmp_65_cast_fu_184_p1 = base_addr_d_reg_128;

assign tmp_s_fu_168_p1 = nLoops;

assign weight_buffer_V_din = tmp_reg_263;

assign weight_cntl_V_din = 1'd0;

assign weights_offset_cast_fu_160_p1 = weights_offset;

always @ (posedge ap_clk) begin
    weights_offset_cast_reg_225[31] <= 1'b0;
    tmp_s_reg_235[31:6] <= 26'b00000000000000000000000000;
end

endmodule //copy_weight_fmem2buf
