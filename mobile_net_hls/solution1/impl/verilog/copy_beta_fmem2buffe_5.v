...
reg   [0:0] tmp_170_reg_227;
reg   [1:0] i_reg_136;
wire   [0:0] tmp_626_fu_157_p2;
wire   [2:0] tmp_627_fu_167_p1;
reg   [2:0] tmp_627_reg_210;
reg   [31:0] betas_addr_reg_216;
reg    ap_sig_ioackin_m_axi_betas_ARREADY;
wire   [0:0] tmp_170_fu_195_p2;
wire    ap_block_state9_pp0_stage0_iter0;
reg    ap_block_state10_pp0_stage0_iter1;
wire    ap_block_state11_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_11001;
reg   [0:0] tmp_170_reg_227_pp0_iter1_reg;
wire   [1:0] i_23_fu_200_p2;
reg    ap_enable_reg_pp0_iter0;
reg   [15:0] tmp_628_reg_236;
wire    ap_CS_fsm_state8;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state9;
reg    ap_enable_reg_pp0_iter2;
wire   [63:0] sum_cast_fu_177_p1;
reg    ap_reg_ioackin_m_axi_betas_ARREADY;
reg    ap_block_pp0_stage0_01001;
wire    ap_CS_fsm_state12;
wire   [5:0] tmp_fu_151_p2;
wire   [31:0] betas_offset_cast_fu_147_p1;
wire   [31:0] tmp_282_cast_fu_163_p1;
wire   [31:0] sum_fu_171_p2;
wire   [2:0] i_cast_cast_fu_191_p1;
reg   [9:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        i_reg_136 <= 2'd0;
    end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (tmp_170_fu_195_p2 == 1'd1))) begin
        i_reg_136 <= i_23_fu_200_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1) & (tmp_626_fu_157_p2 == 1'd1))) begin
        betas_addr_reg_216 <= sum_cast_fu_177_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (tmp_170_reg_227 == 1'd1))) begin
        tmp_628_reg_236 <= m_axi_betas_RDATA;
    end
end

always @ (*) begin
    if ((tmp_170_fu_195_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((beta_buffer_V_full_n == 1'b1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001) & (tmp_170_reg_227_pp0_iter1_reg == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_170_reg_227 == 1'd1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001) & (tmp_170_reg_227 == 1'd1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ap_ST_fsm_state1 : begin
            if (((tmp_626_fu_157_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_state12;
            end else if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1) & (tmp_626_fu_157_p2 == 1'd1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((tmp_170_fu_195_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((tmp_170_fu_195_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_state12;
            end else begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((m_axi_betas_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_170_reg_227 == 1'd1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_betas_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_170_reg_227 == 1'd1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_betas_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_170_reg_227 == 1'd1));
end

always @ (*) begin
    ap_block_state10_pp0_stage0_iter1 = ((m_axi_betas_RVALID == 1'b0) & (tmp_170_reg_227 == 1'd1));
end
...
assign beta_buffer_V_din = tmp_628_reg_236;

assign beta_cntl_V_din = 1'd0;

assign betas_offset_cast_fu_147_p1 = betas_offset;

assign i_23_fu_200_p2 = (i_reg_136 + 2'd1);

assign i_cast_cast_fu_191_p1 = i_reg_136;

assign m_axi_betas_ARADDR = betas_addr_reg_216;
...
assign m_axi_betas_ARLEN = tmp_627_reg_210;
...
assign sum_cast_fu_177_p1 = sum_fu_171_p2;

assign sum_fu_171_p2 = (betas_offset_cast_fu_147_p1 + tmp_282_cast_fu_163_p1);

assign tmp_170_fu_195_p2 = (($signed(i_cast_cast_fu_191_p1) < $signed(tmp_627_reg_210)) ? 1'b1 : 1'b0);

assign tmp_282_cast_fu_163_p1 = n;

assign tmp_626_fu_157_p2 = ((tmp_fu_151_p2 == 6'd0) ? 1'b1 : 1'b0);

assign tmp_627_fu_167_p1 = nLoops[2:0];

assign tmp_fu_151_p2 = (r | c);

endmodule //copy_beta_fmem2buffe_5
