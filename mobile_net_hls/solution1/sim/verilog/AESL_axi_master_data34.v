...
//------------------------Parameter----------------------
`define TV_IN_data34 "../tv/cdatafile/c.moblie_net.autotvin_data34.dat"
`define TV_OUT_data34 "../tv/rtldatafile/rtl.moblie_net.autotvout_data34.dat"
 parameter data34_ADDR_BITWIDTH = 32'd 32;
 parameter data34_AWUSER_BITWIDTH = 32'd 1;
 parameter data34_DATA_BITWIDTH = 32'd 32;
 parameter data34_WUSER_BITWIDTH = 32'd 1;
 parameter data34_ID_BITWIDTH = 32'd 1;
 parameter data34_RUSER_BITWIDTH = 32'd 1;
 parameter data34_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 4;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter data34_C_DATA_BITWIDTH = 32'd 16;
parameter data34_mem_depth = 32'd 4;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_data34_AWVALID;
output  TRAN_data34_AWREADY;
input [data34_ADDR_BITWIDTH - 1 : 0] TRAN_data34_AWADDR;
input [data34_ID_BITWIDTH - 1 : 0] TRAN_data34_AWID;
input [8 - 1 : 0] TRAN_data34_AWLEN;
input [3 - 1 : 0] TRAN_data34_AWSIZE;
input [2 - 1 : 0] TRAN_data34_AWBURST;
input [2 - 1 : 0] TRAN_data34_AWLOCK;
input [4 - 1 : 0] TRAN_data34_AWCACHE;
input [3 - 1 : 0] TRAN_data34_AWPROT;
input [4 - 1 : 0] TRAN_data34_AWQOS;
input [4 - 1 : 0] TRAN_data34_AWREGION;
input [data34_AWUSER_BITWIDTH - 1 : 0] TRAN_data34_AWUSER;
input  TRAN_data34_WVALID;
output  TRAN_data34_WREADY;
input [data34_DATA_BITWIDTH - 1 : 0] TRAN_data34_WDATA;
input [data34_DATA_BITWIDTH/8 - 1 : 0] TRAN_data34_WSTRB;
input  TRAN_data34_WLAST;
input  TRAN_data34_WID;
input [data34_WUSER_BITWIDTH - 1 : 0] TRAN_data34_WUSER;
input  TRAN_data34_ARVALID;
output  TRAN_data34_ARREADY;
input [data34_ADDR_BITWIDTH - 1 : 0] TRAN_data34_ARADDR;
input [data34_ID_BITWIDTH - 1 : 0] TRAN_data34_ARID;
input [8 - 1 : 0] TRAN_data34_ARLEN;
input [3 - 1 : 0] TRAN_data34_ARSIZE;
input [2 - 1 : 0] TRAN_data34_ARBURST;
input [2 - 1 : 0] TRAN_data34_ARLOCK;
input [4 - 1 : 0] TRAN_data34_ARCACHE;
input [3 - 1 : 0] TRAN_data34_ARPROT;
input [4 - 1 : 0] TRAN_data34_ARQOS;
input [4 - 1 : 0] TRAN_data34_ARREGION;
input  TRAN_data34_ARUSER;
output  TRAN_data34_RVALID;
input  TRAN_data34_RREADY;
output [data34_DATA_BITWIDTH - 1 : 0] TRAN_data34_RDATA;
output  TRAN_data34_RLAST;
output [data34_ID_BITWIDTH - 1 : 0] TRAN_data34_RID;
output [data34_RUSER_BITWIDTH - 1 : 0] TRAN_data34_RUSER;
output [2 - 1 : 0] TRAN_data34_RRESP;
output  TRAN_data34_BVALID;
input  TRAN_data34_BREADY;
output [2 - 1 : 0] TRAN_data34_BRESP;
output [data34_ID_BITWIDTH - 1 : 0] TRAN_data34_BID;
output [data34_BUSER_BITWIDTH - 1 : 0] TRAN_data34_BUSER;
output [32 - 1 : 0] TRAN_data34_betas9;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [data34_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [data34_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [data34_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [data34_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [data34_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [data34_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg [data34_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [32 - 1 : 0] betas9 = 0;
reg [data34_DATA_BITWIDTH - 1 : 0] data34_mem_0 [0: data34_mem_depth - 1]; 
reg [data34_DATA_BITWIDTH - 1 : 0] data34_mem_1 [0: data34_mem_depth - 1]; 
reg [data34_DATA_BITWIDTH - 1 : 0] data34_mem_2 [0: data34_mem_depth - 1]; 
reg [data34_DATA_BITWIDTH - 1 : 0] data34_mem_3 [0: data34_mem_depth - 1]; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [data34_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [data34_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [data34_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_data34_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_data34_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_data34_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_data34_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_data34_BRESP = BRESP_tmp;
assign TRAN_data34_RDATA = RDATA_tmp;
assign TRAN_data34_RRESP = RRESP_tmp;
assign TRAN_data34_RLAST = RLAST_tmp;
assign TRAN_data34_RVALID = RVALID_tmp;
assign    TRAN_data34_betas9 = betas9;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = data34_C_DATA_BITWIDTH;
  count_c_data_byte_num_by_bitwidth (c_bitwidth , DATA_byte_num);
  betas9 <= 0 * DATA_byte_num;
end

initial begin : initialize_data34_mem
  integer i;
  for (i = 0; i < data34_mem_depth; i = i + 1) begin
      data34_mem_0[i] = 0;
      data34_mem_1[i] = 0;
      data34_mem_2[i] = 0;
      data34_mem_3[i] = 0;
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_data34_AWREADY & TRAN_data34_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_data34_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_data34_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_data34_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_data34_AWBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_data34_ARREADY & TRAN_data34_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_data34_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_data34_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_data34_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_data34_ARBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_data34_WREADY & TRAN_data34_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_data34_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_data34_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_data34_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_data34_AWVALID && TRAN_data34_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_data34_ARVALID && TRAN_data34_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_data34_WVALID && TRAN_data34_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_data34_WVALID && TRAN_data34_WREADY && TRAN_data34_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_data34_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_data34_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [data34_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [data34_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [data34_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > data34_mem_depth) begin
                $display ("D:/work/place/CNN/project/mobile_net_hls_v1/solution1/sim/verilog/AESL_axi_master_data34.v: Write request address %d exceed AXI master data34 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, data34_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = data34_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = data34_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = data34_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        3 : WDATA_tmp[j] = data34_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : data34_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : data34_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : data34_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            3 : data34_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = data34_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = data34_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = data34_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        3 : WDATA_tmp[j] = data34_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : data34_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : data34_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : data34_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            3 : data34_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > data34_mem_depth) begin
                $display ("D:/work/place/CNN/project/mobile_net_hls_v1/solution1/sim/verilog/AESL_axi_master_data34.v: Read request address %d exceed AXI master data34 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, data34_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= data34_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= data34_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= data34_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            3 : RDATA_tmp <= data34_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_data34_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= data34_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= data34_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= data34_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            3 : RDATA_tmp <= data34_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer data34_bitwidth; 
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [data34_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
  reg [data34_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  data34_bitwidth = data34_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (data34_bitwidth , factor);
  fp = $fopen(`TV_IN_data34,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_data34); 
      $finish; 
  end 
  token = read_token(fp); 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      mem_tmp [data34_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < 4 ; i = i + 1) begin 
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : data34_mem_0[i/factor] = mem_tmp;
                      1 : data34_mem_1[i/factor] = mem_tmp;
                      2 : data34_mem_2[i/factor] = mem_tmp;
                      3 : data34_mem_3[i/factor] = mem_tmp;
          ...
          if (factor == 1) begin
              mem_tmp = token_tmp;
              case(mem_page)
                  0 : data34_mem_0[i] = mem_tmp;
                  1 : data34_mem_1[i] = mem_tmp;
                  2 : data34_mem_2[i] = mem_tmp;
                  3 : data34_mem_3[i] = mem_tmp;
                  default: $display("The page_num of read file is not valid!");
              endcase
              mem_tmp [data34_DATA_BITWIDTH - 1: 0] = 0;
          end
