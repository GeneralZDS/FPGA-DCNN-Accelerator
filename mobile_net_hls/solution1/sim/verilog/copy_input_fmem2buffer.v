...
reg   [31:0] inputs_addr_reg_180;
wire   [5:0] i_2_fu_163_p2;
...
reg   [0:0] exitcond_reg_189_pp0_iter1_reg;
wire   [31:0] tmp_s_fu_153_p1;
reg   [31:0] reg_194;
wire    ap_CS_fsm_state8;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state9;
reg    ap_enable_reg_pp0_iter2;
wire   [63:0] sum_cast_fu_143_p1;
reg    ap_reg_ioackin_m_axi_inputs_ARREADY;
reg    ap_block_pp0_stage0_01001;
wire    ap_CS_fsm_state12;
wire   [31:0] tmp_cast_fu_133_p1;
wire   [31:0] inputs_offset_cast_fu_129_p1;
wire   [31:0] sum_fu_137_p2;
reg   [9:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_158_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_reg_118 <= i_2_fu_163_p2;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        i_reg_118 <= 6'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_reg_189 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        reg_194 <= m_axi_inputs_RDATA;
    end else if (((1'b1 == ap_CS_fsm_state2) & (ap_sig_ioackin_m_axi_inputs_ARREADY == 1'b1))) begin
        reg_194 <= tmp_s_fu_153_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        exitcond_reg_189 <= exitcond_fu_158_p2;
        exitcond_reg_189_pp0_iter1_reg <= exitcond_reg_189;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        inputs_addr_reg_180 <= sum_cast_fu_143_p1;
    end
end
...
always @ (*) begin
    if (((exitcond_reg_189_pp0_iter1_reg == 1'd0) & (input_buffer_V_full_n == 1'b1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((input_cntl_V_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state12))) begin
...
always @ (*) begin
    if (((exitcond_reg_189 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((ap_reg_ioackin_m_axi_inputs_ARREADY == 1'b0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if (((exitcond_reg_189 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (ap_sig_ioackin_m_axi_inputs_ARREADY == 1'b1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_fu_158_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_fu_158_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond_reg_189 == 1'd0) & (m_axi_inputs_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((exitcond_reg_189 == 1'd0) & (m_axi_inputs_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((exitcond_reg_189 == 1'd0) & (m_axi_inputs_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_state10_pp0_stage0_iter1 = ((exitcond_reg_189 == 1'd0) & (m_axi_inputs_RVALID == 1'b0));
end
...
assign exitcond_fu_158_p2 = ((i_reg_118 == nLoops) ? 1'b1 : 1'b0);

assign i_2_fu_163_p2 = (i_reg_118 + 6'd1);

assign input_buffer_V_din = reg_194;

assign input_cntl_V_din = 1'd0;

assign inputs_offset_cast_fu_129_p1 = inputs_offset;

assign m_axi_inputs_ARADDR = inputs_addr_reg_180;
...
assign m_axi_inputs_ARLEN = nLoops;
...
assign sum_cast_fu_143_p1 = sum_fu_137_p2;

assign sum_fu_137_p2 = (tmp_cast_fu_133_p1 + inputs_offset_cast_fu_129_p1);

assign tmp_cast_fu_133_p1 = n;

assign tmp_s_fu_153_p1 = nLoops;

endmodule //copy_input_fmem2buffer
