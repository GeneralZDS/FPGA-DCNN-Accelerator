...
module AESL_axi_master_data33 (
    ...
    TRAN_data33_BID,
    TRAN_data33_BUSER,
    TRAN_data33_weights9,
    ready,
    done
    );

//------------------------Parameter----------------------
`define TV_IN_data33 "../tv/cdatafile/c.moblie_net.autotvin_data33.dat"
`define TV_OUT_data33 "../tv/rtldatafile/rtl.moblie_net.autotvout_data33.dat"
 parameter data33_ADDR_BITWIDTH = 32'd 32;
 parameter data33_AWUSER_BITWIDTH = 32'd 1;
 parameter data33_DATA_BITWIDTH = 32'd 32;
 parameter data33_WUSER_BITWIDTH = 32'd 1;
 parameter data33_ID_BITWIDTH = 32'd 1;
 parameter data33_RUSER_BITWIDTH = 32'd 1;
 parameter data33_BUSER_BITWIDTH = 32'd 1;
 parameter   FIFO_DEPTH            =   1 + 1;
 parameter   mem_page_num            =   32'd 4;
 parameter   FIFO_DEPTH_ADDR_WIDTH   =    32'd 32;
parameter data33_C_DATA_BITWIDTH = 32'd 16;
parameter data33_mem_depth = 32'd 2048;
parameter ReadReqLatency = 32'd 1;
parameter WriteReqLatency = 32'd 1;
// Input and Output
input clk;
input reset;
input  TRAN_data33_AWVALID;
output  TRAN_data33_AWREADY;
input [data33_ADDR_BITWIDTH - 1 : 0] TRAN_data33_AWADDR;
input [data33_ID_BITWIDTH - 1 : 0] TRAN_data33_AWID;
input [8 - 1 : 0] TRAN_data33_AWLEN;
input [3 - 1 : 0] TRAN_data33_AWSIZE;
input [2 - 1 : 0] TRAN_data33_AWBURST;
input [2 - 1 : 0] TRAN_data33_AWLOCK;
input [4 - 1 : 0] TRAN_data33_AWCACHE;
input [3 - 1 : 0] TRAN_data33_AWPROT;
input [4 - 1 : 0] TRAN_data33_AWQOS;
input [4 - 1 : 0] TRAN_data33_AWREGION;
input [data33_AWUSER_BITWIDTH - 1 : 0] TRAN_data33_AWUSER;
input  TRAN_data33_WVALID;
output  TRAN_data33_WREADY;
input [data33_DATA_BITWIDTH - 1 : 0] TRAN_data33_WDATA;
input [data33_DATA_BITWIDTH/8 - 1 : 0] TRAN_data33_WSTRB;
input  TRAN_data33_WLAST;
input  TRAN_data33_WID;
input [data33_WUSER_BITWIDTH - 1 : 0] TRAN_data33_WUSER;
input  TRAN_data33_ARVALID;
output  TRAN_data33_ARREADY;
input [data33_ADDR_BITWIDTH - 1 : 0] TRAN_data33_ARADDR;
input [data33_ID_BITWIDTH - 1 : 0] TRAN_data33_ARID;
input [8 - 1 : 0] TRAN_data33_ARLEN;
input [3 - 1 : 0] TRAN_data33_ARSIZE;
input [2 - 1 : 0] TRAN_data33_ARBURST;
input [2 - 1 : 0] TRAN_data33_ARLOCK;
input [4 - 1 : 0] TRAN_data33_ARCACHE;
input [3 - 1 : 0] TRAN_data33_ARPROT;
input [4 - 1 : 0] TRAN_data33_ARQOS;
input [4 - 1 : 0] TRAN_data33_ARREGION;
input  TRAN_data33_ARUSER;
output  TRAN_data33_RVALID;
input  TRAN_data33_RREADY;
output [data33_DATA_BITWIDTH - 1 : 0] TRAN_data33_RDATA;
output  TRAN_data33_RLAST;
output [data33_ID_BITWIDTH - 1 : 0] TRAN_data33_RID;
output [data33_RUSER_BITWIDTH - 1 : 0] TRAN_data33_RUSER;
output [2 - 1 : 0] TRAN_data33_RRESP;
output  TRAN_data33_BVALID;
input  TRAN_data33_BREADY;
output [2 - 1 : 0] TRAN_data33_BRESP;
output [data33_ID_BITWIDTH - 1 : 0] TRAN_data33_BID;
output [data33_BUSER_BITWIDTH - 1 : 0] TRAN_data33_BUSER;
output [32 - 1 : 0] TRAN_data33_weights9;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [data33_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [data33_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [data33_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [data33_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [data33_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [data33_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg [data33_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [32 - 1 : 0] weights9 = 0;
reg [data33_DATA_BITWIDTH - 1 : 0] data33_mem_0 [0: data33_mem_depth - 1]; 
reg [data33_DATA_BITWIDTH - 1 : 0] data33_mem_1 [0: data33_mem_depth - 1]; 
reg [data33_DATA_BITWIDTH - 1 : 0] data33_mem_2 [0: data33_mem_depth - 1]; 
reg [data33_DATA_BITWIDTH - 1 : 0] data33_mem_3 [0: data33_mem_depth - 1]; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [data33_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [data33_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [data33_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_data33_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_data33_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_data33_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_data33_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_data33_BRESP = BRESP_tmp;
assign TRAN_data33_RDATA = RDATA_tmp;
assign TRAN_data33_RRESP = RRESP_tmp;
assign TRAN_data33_RLAST = RLAST_tmp;
assign TRAN_data33_RVALID = RVALID_tmp;
assign    TRAN_data33_weights9 = weights9;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = data33_C_DATA_BITWIDTH;
  count_c_data_byte_num_by_bitwidth (c_bitwidth , DATA_byte_num);
  weights9 <= 0 * DATA_byte_num;
end

initial begin : initialize_data33_mem
  integer i;
  for (i = 0; i < data33_mem_depth; i = i + 1) begin
      data33_mem_0[i] = 0;
      data33_mem_1[i] = 0;
      data33_mem_2[i] = 0;
      data33_mem_3[i] = 0;
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_data33_AWREADY & TRAN_data33_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_data33_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_data33_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_data33_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_data33_AWBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_data33_ARREADY & TRAN_data33_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_data33_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_data33_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_data33_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_data33_ARBURST; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_data33_WREADY & TRAN_data33_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_data33_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_data33_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_data33_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_data33_AWVALID && TRAN_data33_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_data33_ARVALID && TRAN_data33_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_data33_WVALID && TRAN_data33_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_data33_WVALID && TRAN_data33_WREADY && TRAN_data33_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_data33_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_data33_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [data33_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [data33_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [data33_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > data33_mem_depth) begin
                $display ("D:/work/place/CNN/project/mobile_net_hls_v1/solution1/sim/verilog/AESL_axi_master_data33.v: Write request address %d exceed AXI master data33 array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, data33_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = data33_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = data33_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = data33_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        3 : WDATA_tmp[j] = data33_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : data33_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : data33_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : data33_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            3 : data33_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = data33_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = data33_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = data33_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        3 : WDATA_tmp[j] = data33_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : data33_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : data33_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : data33_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            3 : data33_mem_3[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > data33_mem_depth) begin
                $display ("D:/work/place/CNN/project/mobile_net_hls_v1/solution1/sim/verilog/AESL_axi_master_data33.v: Read request address %d exceed AXI master data33 array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, data33_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= data33_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= data33_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= data33_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            3 : RDATA_tmp <= data33_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_data33_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= data33_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= data33_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= data33_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            3 : RDATA_tmp <= data33_mem_3[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  integer mem_page; 
  integer data33_bitwidth; 
  reg [127 : 0] token; 
  reg [127 : 0] token_tmp; 
  //reg [data33_C_DATA_BITWIDTH - 1 : 0] token_tmp; 
  reg [data33_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  data33_bitwidth = data33_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (data33_bitwidth , factor);
  fp = $fopen(`TV_IN_data33,"r"); 
  if(fp == 0) begin                               // Failed to open file 
      $display("Failed to open file \"%s\"!", `TV_IN_data33); 
      $finish; 
  end 
  token = read_token(fp); 
  ...
  while (token != "[[[/runtime]]]") begin 
      ...
      mem_tmp [data33_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < 2048 ; i = i + 1) begin 
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : data33_mem_0[i/factor] = mem_tmp;
                      1 : data33_mem_1[i/factor] = mem_tmp;
                      2 : data33_mem_2[i/factor] = mem_tmp;
                      3 : data33_mem_3[i/factor] = mem_tmp;
          ...
          if (factor == 1) begin
              mem_tmp = token_tmp;
              case(mem_page)
                  0 : data33_mem_0[i] = mem_tmp;
                  1 : data33_mem_1[i] = mem_tmp;
                  2 : data33_mem_2[i] = mem_tmp;
                  3 : data33_mem_3[i] = mem_tmp;
                  default: $display("The page_num of read file is not valid!");
              endcase
              mem_tmp [data33_DATA_BITWIDTH - 1: 0] = 0;
          end
