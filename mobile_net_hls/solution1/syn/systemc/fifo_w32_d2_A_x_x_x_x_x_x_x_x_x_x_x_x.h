// ==============================================================
// File generated on Sun Apr 28 16:10:54 +0800 2019
// Vivado(TM) HLS - High-Level Synthesis from C, C++ and SystemC v2018.3 (64-bit)
// SW Build 2405991 on Thu Dec  6 23:38:27 MST 2018
// IP Build 2404404 on Fri Dec  7 01:43:56 MST 2018
// Copyright 1986-2018 Xilinx, Inc. All Rights Reserved.
// ==============================================================
#ifndef fifo_w32_d2_A_x_x_x_x_x_x_x_x_x_x_x_x_HH_
#define fifo_w32_d2_A_x_x_x_x_x_x_x_x_x_x_x_x_HH_

#include <systemc>
using namespace std;
SC_MODULE(fifo_w32_d2_A_x_x_x_x_x_x_x_x_x_x_x_x) {
    static const unsigned int DATA_WIDTH = 32;
    static const unsigned int ADDR_WIDTH = 2;
    static const unsigned int fifo_w32_d2_A_x_x_x_x_x_x_x_x_x_x_x_x_depth = 3;
    ...
    sc_core::sc_signal< sc_dt::sc_lv<DATA_WIDTH> >  mStorage[fifo_w32_d2_A_x_x_x_x_x_x_x_x_x_x_x_x_depth];
    ...
    SC_CTOR(fifo_w32_d2_A_x_x_x_x_x_x_x_x_x_x_x_x) : mTrace(0) {
        ...
        SC_METHOD(proc_dout);
        sensitive << mOutPtr;
        for (unsigned i = 0; i < fifo_w32_d2_A_x_x_x_x_x_x_x_x_x_x_x_x_depth; i++) {
    ...
    ~fifo_w32_d2_A_x_x_x_x_x_x_x_x_x_x_x_x() {
        ...
        if (reset.read() == sc_dt::SC_LOGIC_1) {
            ...
            if (if_read_ce.read() == sc_dt::SC_LOGIC_1
               ...
               && internal_empty_n.read() == sc_dt::SC_LOGIC_1) {
                ...
                if (mOutPtr.read().to_uint() == (fifo_w32_d2_A_x_x_x_x_x_x_x_x_x_x_x_x_depth-1)) {
                    ptr = 0;
                ...
                assert(ptr.to_uint() < fifo_w32_d2_A_x_x_x_x_x_x_x_x_x_x_x_x_depth);
                mOutPtr.write(ptr);
            }
            if (if_write_ce.read() == sc_dt::SC_LOGIC_1
                ...
                if (ptr.to_uint() == (fifo_w32_d2_A_x_x_x_x_x_x_x_x_x_x_x_x_depth-1)) {
                    ptr = 0;
                    mFlag_nEF_hint.write(~mFlag_nEF_hint.read());
                } else {
                    ptr++;
    ...
    void proc_dout() {
        ...
        if (ptr.to_uint() > fifo_w32_d2_A_x_x_x_x_x_x_x_x_x_x_x_x_depth) {
...
#endif //fifo_w32_d2_A_x_x_x_x_x_x_x_x_x_x_x_x_HH_
