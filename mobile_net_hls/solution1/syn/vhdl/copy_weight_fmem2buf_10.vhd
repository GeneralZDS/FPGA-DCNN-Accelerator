...
entity copy_weight_fmem2buf_10 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of copy_weight_fmem2buf_10 is 
    ...
    signal base_addr1_fu_284_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_559_fu_296_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_559_reg_368 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_560_fu_302_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_560_reg_372 : STD_LOGIC_VECTOR (2 downto 0);
    signal tn_7_fu_315_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal tn_7_reg_380 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal i_5_reg_395 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal tmp_561_reg_400 : STD_LOGIC_VECTOR (15 downto 0);
    signal base_addr1_d1_5_fu_352_p2 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal base_addr1_d_reg_235 : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal p_shl_fu_276_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal n_cast3_fu_272_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_fu_290_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal tn_cast_cast_fu_306_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_162_cast_fu_321_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (tmp_559_fu_296_p2 = ap_const_lv1_1) and (ap_start = ap_const_logic_1))) then 
                base_addr1_d_reg_235 <= base_addr1_fu_284_p2;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state13)) then 
                base_addr1_d_reg_235 <= base_addr1_d1_5_fu_352_p2;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                ...
                tmp_561_reg_400 <= m_axi_weights_RDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                tmp_559_reg_368 <= tmp_559_fu_296_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (tmp_559_fu_296_p2 = ap_const_lv1_1) and (ap_start = ap_const_logic_1))) then
                tmp_560_reg_372 <= tmp_560_fu_302_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (tmp_559_reg_368 = ap_const_lv1_1))) then
                tn_7_reg_380 <= tn_7_fu_315_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (tmp_s_fu_310_p2 = ap_const_lv1_1) and (tmp_559_reg_368 = ap_const_lv1_1))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state3, ap_enable_reg_pp0_iter1, tmp_559_reg_368, ap_CS_fsm_state2, tmp_s_fu_310_p2, exitcond_fu_340_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, ap_enable_reg_pp0_iter2, ap_sig_ioackin_m_axi_weights_ARREADY)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and ((tmp_s_fu_310_p2 = ap_const_lv1_0) or (tmp_559_reg_368 = ap_const_lv1_0)))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, tmp_559_reg_368, ap_CS_fsm_state2, tmp_s_fu_310_p2)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((ap_const_logic_1 = ap_CS_fsm_state2) and ((tmp_s_fu_310_p2 = ap_const_lv1_0) or (tmp_559_reg_368 = ap_const_lv1_0))))) then 
    ...
    ap_phi_mux_i_phi_fu_260_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, i_reg_256, exitcond_reg_391, i_5_reg_395)
    begin
        if (((exitcond_reg_391 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            ap_phi_mux_i_phi_fu_260_p4 <= i_5_reg_395;
        else 
    ...
    ap_ready_assign_proc : process(tmp_559_reg_368, ap_CS_fsm_state2, tmp_s_fu_310_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and ((tmp_s_fu_310_p2 = ap_const_lv1_0) or (tmp_559_reg_368 = ap_const_lv1_0)))) then 
    ...
    base_addr1_d1_5_fu_352_p2 <= std_logic_vector(unsigned(base_addr1_d_reg_235) + unsigned(ap_const_lv11_9));
    ...
    i_5_fu_346_p2 <= std_logic_vector(unsigned(ap_phi_mux_i_phi_fu_260_p4) + unsigned(ap_const_lv4_1));
    ...
    n_cast3_fu_272_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(n),11));
    p_shl_fu_276_p3 <= (n & ap_const_lv3_0);
    sum_cast_fu_330_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_fu_325_p2),64));
    sum_fu_325_p2 <= std_logic_vector(unsigned(weights_offset_cast_reg_358) + unsigned(tmp_162_cast_fu_321_p1));
    tmp_162_cast_fu_321_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(base_addr1_d_reg_235),32));
    tmp_559_fu_296_p2 <= "1" when (tmp_fu_290_p2 = ap_const_lv7_0) else "0";
    tmp_560_fu_302_p1 <= nLoops(3 - 1 downto 0);
    tmp_fu_290_p2 <= (r or c);
    tmp_s_fu_310_p2 <= "1" when (signed(tn_cast_cast_fu_306_p1) < signed(tmp_560_reg_372)) else "0";
    tn_7_fu_315_p2 <= std_logic_vector(unsigned(tn_reg_245) + unsigned(ap_const_lv2_1));
    tn_cast_cast_fu_306_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tn_reg_245),3));
    weight_buffer_0_V_din <= tmp_561_reg_400;
    ...
    weight_buffer_1_V_din <= tmp_561_reg_400;
    ...
    weight_buffer_2_V_din <= tmp_561_reg_400;
    ...
    weight_buffer_3_V_din <= tmp_561_reg_400;
    ...
    weight_buffer_4_V_din <= tmp_561_reg_400;
    ...
    weight_buffer_5_V_din <= tmp_561_reg_400;
    ...
    weight_buffer_6_V_din <= tmp_561_reg_400;
    ...
    weight_buffer_7_V_din <= tmp_561_reg_400;
    ...
    weight_buffer_8_V_din <= tmp_561_reg_400;
    ...
    weight_cntl_V_write_assign_proc : process(weight_cntl_V_full_n, tmp_559_reg_368, ap_CS_fsm_state2, tmp_s_fu_310_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (weight_cntl_V_full_n = ap_const_logic_1) and ((tmp_s_fu_310_p2 = ap_const_lv1_0) or (tmp_559_reg_368 = ap_const_lv1_0)))) then 
