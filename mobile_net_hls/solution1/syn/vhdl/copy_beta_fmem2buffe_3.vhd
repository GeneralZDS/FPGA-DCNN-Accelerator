...
entity copy_beta_fmem2buffe_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of copy_beta_fmem2buffe_3 is 
    ...
    signal i_reg_118 : STD_LOGIC_VECTOR (1 downto 0);
    signal betas_addr_reg_169 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal i_25_fu_163_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal tmp_632_reg_194 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_condition_pp0_exit_iter0_state9 : STD_LOGIC;
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal sum_cast_fu_143_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_reg_ioackin_m_axi_betas_ARREADY : STD_LOGIC := '0';
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal ap_CS_fsm_state12 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state12 : signal is "none";
    signal tmp_cast_fu_133_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal betas_offset_cast_fu_129_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal sum_fu_137_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((exitcond_fu_158_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                i_reg_118 <= i_25_fu_163_p2;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                betas_addr_reg_169 <= sum_cast_fu_143_p1(32 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                exitcond_reg_185 <= exitcond_fu_158_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_reg_185 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp_632_reg_194 <= m_axi_betas_RDATA;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, ap_enable_reg_pp0_iter1, ap_sig_ioackin_m_axi_betas_ARREADY, exitcond_fu_158_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, ap_enable_reg_pp0_iter2)
    begin
        case ap_CS_fsm is
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(m_axi_betas_RVALID, ap_enable_reg_pp0_iter1, exitcond_reg_185)
    begin
                ap_block_pp0_stage0_01001 <= ((exitcond_reg_185 = ap_const_lv1_0) and (m_axi_betas_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_betas_RVALID, ap_enable_reg_pp0_iter1, exitcond_reg_185)
    begin
                ap_block_pp0_stage0_11001 <= ((exitcond_reg_185 = ap_const_lv1_0) and (m_axi_betas_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_betas_RVALID, ap_enable_reg_pp0_iter1, exitcond_reg_185)
    begin
                ap_block_pp0_stage0_subdone <= ((exitcond_reg_185 = ap_const_lv1_0) and (m_axi_betas_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_state10_pp0_stage0_iter1_assign_proc : process(m_axi_betas_RVALID, exitcond_reg_185)
    begin
                ap_block_state10_pp0_stage0_iter1 <= ((exitcond_reg_185 = ap_const_lv1_0) and (m_axi_betas_RVALID = ap_const_logic_0));
    end process;

        ap_block_state11_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));
        ap_block_state9_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_pp0_exit_iter0_state9_assign_proc : process(exitcond_fu_158_p2)
    begin
    ...
    beta_buffer_V_din <= tmp_632_reg_194;

    beta_buffer_V_write_assign_proc : process(beta_buffer_V_full_n, ap_block_pp0_stage0_11001, exitcond_reg_185_pp0_iter1_reg, ap_enable_reg_pp0_iter2)
    begin
        if (((exitcond_reg_185_pp0_iter1_reg = ap_const_lv1_0) and (beta_buffer_V_full_n = ap_const_logic_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    betas_blk_n_R_assign_proc : process(m_axi_betas_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond_reg_185)
    begin
        if (((exitcond_reg_185 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    betas_offset_cast_fu_129_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(betas_offset),32));
    exitcond_fu_158_p2 <= "1" when (i_reg_118 = nLoops) else "0";
    i_25_fu_163_p2 <= std_logic_vector(unsigned(i_reg_118) + unsigned(ap_const_lv2_1));
    m_axi_betas_ARADDR <= betas_addr_reg_169;
    m_axi_betas_ARBURST <= ap_const_lv2_0;
    m_axi_betas_ARCACHE <= ap_const_lv4_0;
    m_axi_betas_ARID <= ap_const_lv1_0;
    m_axi_betas_ARLEN <= std_logic_vector(IEEE.numeric_std.resize(unsigned(nLoops),32));
    ...
    m_axi_betas_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond_reg_185, ap_block_pp0_stage0_11001)
    begin
        if (((exitcond_reg_185 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    sum_cast_fu_143_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_fu_137_p2),64));
    sum_fu_137_p2 <= std_logic_vector(unsigned(tmp_cast_fu_133_p1) + unsigned(betas_offset_cast_fu_129_p1));
    tmp_cast_fu_133_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(n),32));
end behav;
