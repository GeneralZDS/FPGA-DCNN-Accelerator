...
entity copy_beta_fmem2buffe_4 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of copy_beta_fmem2buffe_4 is 
    ...
    signal tmp_172_reg_229 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_reg_138 : STD_LOGIC_VECTOR (1 downto 0);
    signal tmp_629_fu_159_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_630_fu_169_p1 : STD_LOGIC_VECTOR (2 downto 0);
    signal tmp_630_reg_212 : STD_LOGIC_VECTOR (2 downto 0);
    signal betas_addr_reg_218 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_sig_ioackin_m_axi_betas_ARREADY : STD_LOGIC;
    signal tmp_172_fu_197_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state9_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state10_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state11_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal tmp_172_reg_229_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal i_24_fu_202_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal tmp_631_reg_238 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal tmp_fu_153_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal betas_offset_cast_fu_149_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_286_cast_fu_165_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_172_fu_197_p2 = ap_const_lv1_1))) then 
                i_reg_138 <= i_24_fu_202_p2;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1) and (tmp_629_fu_159_p2 = ap_const_lv1_1))) then
                betas_addr_reg_218 <= sum_cast_fu_179_p1(32 - 1 downto 0);
                tmp_630_reg_212 <= tmp_630_fu_169_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp_172_reg_229 <= tmp_172_fu_197_p2;
                tmp_172_reg_229_pp0_iter1_reg <= tmp_172_reg_229;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_172_reg_229 = ap_const_lv1_1))) then
                tmp_631_reg_238 <= m_axi_betas_RDATA;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, ap_enable_reg_pp0_iter1, tmp_629_fu_159_p2, ap_sig_ioackin_m_axi_betas_ARREADY, tmp_172_fu_197_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, ap_enable_reg_pp0_iter2)
    begin
        case ap_CS_fsm is
            when ap_ST_fsm_state1 => 
                if (((tmp_629_fu_159_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state12;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1) and (tmp_629_fu_159_p2 = ap_const_lv1_1))) then
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((tmp_172_fu_197_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))) and not(((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif ((((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0)) or ((tmp_172_fu_197_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0)))) then
                    ap_NS_fsm <= ap_ST_fsm_state12;
                else
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                end if;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(m_axi_betas_RVALID, ap_enable_reg_pp0_iter1, tmp_172_reg_229)
    begin
                ap_block_pp0_stage0_01001 <= ((m_axi_betas_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (tmp_172_reg_229 = ap_const_lv1_1));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_betas_RVALID, ap_enable_reg_pp0_iter1, tmp_172_reg_229)
    begin
                ap_block_pp0_stage0_11001 <= ((m_axi_betas_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (tmp_172_reg_229 = ap_const_lv1_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_betas_RVALID, ap_enable_reg_pp0_iter1, tmp_172_reg_229)
    begin
                ap_block_pp0_stage0_subdone <= ((m_axi_betas_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (tmp_172_reg_229 = ap_const_lv1_1));
    end process;


    ap_block_state10_pp0_stage0_iter1_assign_proc : process(m_axi_betas_RVALID, tmp_172_reg_229)
    begin
                ap_block_state10_pp0_stage0_iter1 <= ((m_axi_betas_RVALID = ap_const_logic_0) and (tmp_172_reg_229 = ap_const_lv1_1));
    end process;

        ap_block_state11_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));
        ap_block_state9_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_pp0_exit_iter0_state9_assign_proc : process(tmp_172_fu_197_p2)
    begin
        if ((tmp_172_fu_197_p2 = ap_const_lv1_0)) then 
    ...
    beta_buffer_V_din <= tmp_631_reg_238;

    beta_buffer_V_write_assign_proc : process(beta_buffer_V_full_n, ap_block_pp0_stage0_11001, tmp_172_reg_229_pp0_iter1_reg, ap_enable_reg_pp0_iter2)
    begin
        if (((beta_buffer_V_full_n = ap_const_logic_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_172_reg_229_pp0_iter1_reg = ap_const_lv1_1))) then 
    ...
    betas_blk_n_R_assign_proc : process(m_axi_betas_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, tmp_172_reg_229)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_172_reg_229 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    i_24_fu_202_p2 <= std_logic_vector(unsigned(i_reg_138) + unsigned(ap_const_lv2_1));
    ...
    m_axi_betas_ARLEN <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_630_reg_212),32));
    ...
    m_axi_betas_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_172_reg_229, ap_block_pp0_stage0_11001)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (tmp_172_reg_229 = ap_const_lv1_1))) then 
    ...
    sum_fu_173_p2 <= std_logic_vector(unsigned(betas_offset_cast_fu_149_p1) + unsigned(tmp_286_cast_fu_165_p1));
    tmp_172_fu_197_p2 <= "1" when (signed(i_cast_cast_fu_193_p1) < signed(tmp_630_reg_212)) else "0";
    tmp_286_cast_fu_165_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(n),32));
    tmp_629_fu_159_p2 <= "1" when (tmp_fu_153_p2 = ap_const_lv9_0) else "0";
    tmp_630_fu_169_p1 <= nLoops(3 - 1 downto 0);
