...
entity copy_weight_fmem2buf_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of copy_weight_fmem2buf_2 is 
    ...
    signal tmp_556_fu_387_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_556_reg_467 : STD_LOGIC_VECTOR (5 downto 0);
    signal tn_4_fu_396_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal tn_4_reg_475 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tm_4_fu_411_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal tm_4_reg_483 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_557_fu_421_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_557_reg_488 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_13_fu_406_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal weights_addr_reg_492 : STD_LOGIC_VECTOR (31 downto 0);
    signal base_addr_d1_9_fu_440_p2 : STD_LOGIC_VECTOR (17 downto 0);
    signal tmp_558_reg_503 : STD_LOGIC_VECTOR (15 downto 0);
    signal base_addr_d2_8_fu_446_p2 : STD_LOGIC_VECTOR (17 downto 0);
    ...
    signal tmp_555_fu_361_p1 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal tmp_125_cast_fu_417_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_13_fu_406_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state3))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (tmp_13_fu_406_p2 = ap_const_lv1_1))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, m_axi_weights_RVALID, ap_CS_fsm_state4, ap_CS_fsm_state11, ap_CS_fsm_state2, ap_CS_fsm_state3, tmp_13_fu_406_p2, exitcond_fu_391_p2, ap_sig_ioackin_m_axi_weights_ARREADY)
    begin
        case ap_CS_fsm is
    ...
    base_addr_d1_9_fu_440_p2 <= std_logic_vector(unsigned(base_addr_d2_reg_314) + unsigned(ap_const_lv18_200));
    base_addr_d2_8_fu_446_p2 <= std_logic_vector(unsigned(base_addr_d_reg_335) + unsigned(ap_const_lv18_1));
    ...
    sum_fu_425_p2 <= std_logic_vector(unsigned(weights_offset_cast_reg_457) + unsigned(tmp_125_cast_fu_417_p1));
    tm_4_fu_411_p2 <= std_logic_vector(unsigned(tm_reg_346) + unsigned(ap_const_lv5_1));
    tm_cast_cast_fu_402_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tm_reg_346),6));
    tmp_125_cast_fu_417_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(base_addr_d_reg_335),32));
    tmp_13_fu_406_p2 <= "1" when (signed(tm_cast_cast_fu_402_p1) < signed(tmp_556_reg_467)) else "0";
    tmp_555_fu_361_p1 <= n(8 - 1 downto 0);
    tmp_556_fu_387_p1 <= mLoops(6 - 1 downto 0);
    tmp_557_fu_421_p1 <= tm_reg_346(4 - 1 downto 0);
    tmp_cast3_fu_373_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_fu_365_p3),18));
    tmp_fu_365_p3 <= (tmp_555_fu_361_p1 & ap_const_lv9_0);
    tn_4_fu_396_p2 <= std_logic_vector(unsigned(tn_reg_324) + unsigned(ap_const_lv2_1));
    weight_buffer_0_V_din <= tmp_558_reg_503;

    weight_buffer_0_V_write_assign_proc : process(weight_buffer_0_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((tmp_557_reg_488 = ap_const_lv4_0) and (weight_buffer_0_V_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state12))) then 
    ...
    weight_buffer_10_V_din <= tmp_558_reg_503;

    weight_buffer_10_V_write_assign_proc : process(weight_buffer_10_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state12) and (weight_buffer_10_V_full_n = ap_const_logic_1) and (tmp_557_reg_488 = ap_const_lv4_A))) then 
    ...
    weight_buffer_11_V_din <= tmp_558_reg_503;

    weight_buffer_11_V_write_assign_proc : process(weight_buffer_11_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state12) and (weight_buffer_11_V_full_n = ap_const_logic_1) and (tmp_557_reg_488 = ap_const_lv4_B))) then 
    ...
    weight_buffer_12_V_din <= tmp_558_reg_503;

    weight_buffer_12_V_write_assign_proc : process(weight_buffer_12_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state12) and (weight_buffer_12_V_full_n = ap_const_logic_1) and (tmp_557_reg_488 = ap_const_lv4_C))) then 
    ...
    weight_buffer_13_V_din <= tmp_558_reg_503;

    weight_buffer_13_V_write_assign_proc : process(weight_buffer_13_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state12) and (weight_buffer_13_V_full_n = ap_const_logic_1) and (tmp_557_reg_488 = ap_const_lv4_D))) then 
    ...
    weight_buffer_14_V_din <= tmp_558_reg_503;

    weight_buffer_14_V_write_assign_proc : process(weight_buffer_14_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state12) and (weight_buffer_14_V_full_n = ap_const_logic_1) and (tmp_557_reg_488 = ap_const_lv4_E))) then 
    ...
    weight_buffer_15_V_din <= tmp_558_reg_503;

    weight_buffer_15_V_write_assign_proc : process(weight_buffer_15_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state12) and (weight_buffer_15_V_full_n = ap_const_logic_1) and (tmp_557_reg_488 = ap_const_lv4_F))) then 
    ...
    weight_buffer_1_V_din <= tmp_558_reg_503;

    weight_buffer_1_V_write_assign_proc : process(weight_buffer_1_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((weight_buffer_1_V_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state12) and (tmp_557_reg_488 = ap_const_lv4_1))) then 
    ...
    weight_buffer_2_V_din <= tmp_558_reg_503;

    weight_buffer_2_V_write_assign_proc : process(weight_buffer_2_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((weight_buffer_2_V_full_n = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state12) and (tmp_557_reg_488 = ap_const_lv4_2))) then 
    ...
    weight_buffer_3_V_din <= tmp_558_reg_503;

    weight_buffer_3_V_write_assign_proc : process(weight_buffer_3_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state12) and (weight_buffer_3_V_full_n = ap_const_logic_1) and (tmp_557_reg_488 = ap_const_lv4_3))) then 
    ...
    weight_buffer_4_V_din <= tmp_558_reg_503;

    weight_buffer_4_V_write_assign_proc : process(weight_buffer_4_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state12) and (weight_buffer_4_V_full_n = ap_const_logic_1) and (tmp_557_reg_488 = ap_const_lv4_4))) then 
    ...
    weight_buffer_5_V_din <= tmp_558_reg_503;

    weight_buffer_5_V_write_assign_proc : process(weight_buffer_5_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state12) and (weight_buffer_5_V_full_n = ap_const_logic_1) and (tmp_557_reg_488 = ap_const_lv4_5))) then 
    ...
    weight_buffer_6_V_din <= tmp_558_reg_503;

    weight_buffer_6_V_write_assign_proc : process(weight_buffer_6_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state12) and (weight_buffer_6_V_full_n = ap_const_logic_1) and (tmp_557_reg_488 = ap_const_lv4_6))) then 
    ...
    weight_buffer_7_V_din <= tmp_558_reg_503;

    weight_buffer_7_V_write_assign_proc : process(weight_buffer_7_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state12) and (weight_buffer_7_V_full_n = ap_const_logic_1) and (tmp_557_reg_488 = ap_const_lv4_7))) then 
    ...
    weight_buffer_8_V_din <= tmp_558_reg_503;

    weight_buffer_8_V_write_assign_proc : process(weight_buffer_8_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state12) and (weight_buffer_8_V_full_n = ap_const_logic_1) and (tmp_557_reg_488 = ap_const_lv4_8))) then 
    ...
    weight_buffer_9_V_din <= tmp_558_reg_503;

    weight_buffer_9_V_write_assign_proc : process(weight_buffer_9_V_full_n, tmp_557_reg_488, ap_CS_fsm_state12)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state12) and (weight_buffer_9_V_full_n = ap_const_logic_1) and (tmp_557_reg_488 = ap_const_lv4_9))) then 
