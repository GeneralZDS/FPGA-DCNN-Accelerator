...
entity copy_weight_fmem2buf_7 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of copy_weight_fmem2buf_7 is 
    ...
    signal i_reg_238_pp0_iter1_reg : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_block_state10_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state11_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state12_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal weights_offset_cast_fu_250_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal weights_offset_cast_reg_333 : STD_LOGIC_VECTOR (31 downto 0);
    signal base_addr1_fu_274_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tn_3_fu_285_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal tn_3_reg_346 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal weights_addr_reg_351 : STD_LOGIC_VECTOR (31 downto 0);
    signal exitcond1_fu_280_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal exitcond_fu_310_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal exitcond_reg_357 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_3_fu_316_p2 : STD_LOGIC_VECTOR (3 downto 0);
    signal i_3_reg_361 : STD_LOGIC_VECTOR (3 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal tmp_540_reg_366 : STD_LOGIC_VECTOR (15 downto 0);
    signal base_addr1_d1_3_fu_322_p2 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal base_addr1_d_reg_217 : STD_LOGIC_VECTOR (12 downto 0);
    signal tn_reg_227 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_phi_mux_i_phi_fu_242_p4 : STD_LOGIC_VECTOR (3 downto 0);
    signal sum_cast_fu_300_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_reg_ioackin_m_axi_weights_ARREADY : STD_LOGIC := '0';
    signal ap_sig_ioackin_m_axi_weights_ARREADY : STD_LOGIC;
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal tmp_539_fu_254_p1 : STD_LOGIC_VECTOR (8 downto 0);
    signal p_shl_fu_258_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal p_shl_cast4_fu_266_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal n_cast_cast_fu_270_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_cast_fu_291_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal sum_fu_295_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    base_addr1_d_reg_217_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_reg_357 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond1_fu_280_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                weights_addr_reg_351 <= sum_cast_fu_300_p1(32 - 1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                    weights_offset_cast_reg_333(30 downto 0) <= weights_offset_cast_fu_250_p1(30 downto 0);
            end if;
        end if;
    end process;
    weights_offset_cast_reg_333(31) <= '0';

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state3, ap_enable_reg_pp0_iter1, ap_CS_fsm_state2, exitcond1_fu_280_p2, exitcond_fu_310_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, ap_enable_reg_pp0_iter2, ap_sig_ioackin_m_axi_weights_ARREADY)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond1_fu_280_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if ((not(((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (exitcond_fu_310_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))) and not(((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_enable_reg_pp0_iter1 = ap_const_logic_0))))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
    ...
    ap_condition_pp0_exit_iter0_state10_assign_proc : process(exitcond_fu_310_p2)
    begin
        if ((exitcond_fu_310_p2 = ap_const_lv1_1)) then 
    ...
    ap_done_assign_proc : process(ap_start, ap_CS_fsm_state1, ap_CS_fsm_state2, exitcond1_fu_280_p2)
    begin
        if ((((ap_start = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state1)) or ((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond1_fu_280_p2 = ap_const_lv1_1)))) then 
    ...
    ap_phi_mux_i_phi_fu_242_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, i_reg_238, exitcond_reg_357, i_3_reg_361)
    begin
        if (((exitcond_reg_357 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, exitcond1_fu_280_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (exitcond1_fu_280_p2 = ap_const_lv1_1))) then 
    ...
    base_addr1_d1_3_fu_322_p2 <= std_logic_vector(unsigned(base_addr1_d_reg_217) + unsigned(ap_const_lv13_9));
    base_addr1_fu_274_p2 <= std_logic_vector(unsigned(p_shl_cast4_fu_266_p1) + unsigned(n_cast_cast_fu_270_p1));
    exitcond1_fu_280_p2 <= "1" when (tn_reg_227 = nLoops) else "0";
    exitcond_fu_310_p2 <= "1" when (ap_phi_mux_i_phi_fu_242_p4 = ap_const_lv4_9) else "0";
    i_3_fu_316_p2 <= std_logic_vector(unsigned(ap_phi_mux_i_phi_fu_242_p4) + unsigned(ap_const_lv4_1));
    m_axi_weights_ARADDR <= weights_addr_reg_351;
    ...
    n_cast_cast_fu_270_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(n),13));
    p_shl_cast4_fu_266_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(p_shl_fu_258_p3),13));
    p_shl_fu_258_p3 <= (tmp_539_fu_254_p1 & ap_const_lv3_0);
    sum_cast_fu_300_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_fu_295_p2),64));
    sum_fu_295_p2 <= std_logic_vector(unsigned(weights_offset_cast_reg_333) + unsigned(tmp_cast_fu_291_p1));
    tmp_539_fu_254_p1 <= n(9 - 1 downto 0);
    tmp_cast_fu_291_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(base_addr1_d_reg_217),32));
    tn_3_fu_285_p2 <= std_logic_vector(unsigned(tn_reg_227) + unsigned(ap_const_lv2_1));
    weight_buffer_0_V_din <= tmp_540_reg_366;

    weight_buffer_0_V_write_assign_proc : process(weight_buffer_0_V_full_n, i_reg_238_pp0_iter1_reg, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter2)
    begin
        if (((i_reg_238_pp0_iter1_reg = ap_const_lv4_0) and (weight_buffer_0_V_full_n = ap_const_logic_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    weight_buffer_1_V_din <= tmp_540_reg_366;

    weight_buffer_1_V_write_assign_proc : process(weight_buffer_1_V_full_n, i_reg_238_pp0_iter1_reg, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter2)
    begin
        if (((weight_buffer_1_V_full_n = ap_const_logic_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (i_reg_238_pp0_iter1_reg = ap_const_lv4_1))) then 
    ...
    weight_buffer_2_V_din <= tmp_540_reg_366;

    weight_buffer_2_V_write_assign_proc : process(weight_buffer_2_V_full_n, i_reg_238_pp0_iter1_reg, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter2)
    begin
        if (((weight_buffer_2_V_full_n = ap_const_logic_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (i_reg_238_pp0_iter1_reg = ap_const_lv4_2))) then 
    ...
    weight_buffer_3_V_din <= tmp_540_reg_366;

    weight_buffer_3_V_write_assign_proc : process(weight_buffer_3_V_full_n, i_reg_238_pp0_iter1_reg, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter2)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (weight_buffer_3_V_full_n = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (i_reg_238_pp0_iter1_reg = ap_const_lv4_3))) then 
    ...
    weight_buffer_4_V_din <= tmp_540_reg_366;

    weight_buffer_4_V_write_assign_proc : process(weight_buffer_4_V_full_n, i_reg_238_pp0_iter1_reg, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter2)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (weight_buffer_4_V_full_n = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (i_reg_238_pp0_iter1_reg = ap_const_lv4_4))) then 
    ...
    weight_buffer_5_V_din <= tmp_540_reg_366;

    weight_buffer_5_V_write_assign_proc : process(weight_buffer_5_V_full_n, i_reg_238_pp0_iter1_reg, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter2)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (weight_buffer_5_V_full_n = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (i_reg_238_pp0_iter1_reg = ap_const_lv4_5))) then 
    ...
    weight_buffer_6_V_din <= tmp_540_reg_366;

    weight_buffer_6_V_write_assign_proc : process(weight_buffer_6_V_full_n, i_reg_238_pp0_iter1_reg, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter2)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (weight_buffer_6_V_full_n = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (i_reg_238_pp0_iter1_reg = ap_const_lv4_6))) then 
    ...
    weight_buffer_7_V_din <= tmp_540_reg_366;

    weight_buffer_7_V_write_assign_proc : process(weight_buffer_7_V_full_n, i_reg_238_pp0_iter1_reg, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter2)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (weight_buffer_7_V_full_n = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (i_reg_238_pp0_iter1_reg = ap_const_lv4_7))) then 
    ...
    weight_buffer_8_V_din <= tmp_540_reg_366;

    weight_buffer_8_V_write_assign_proc : process(weight_buffer_8_V_full_n, i_reg_238_pp0_iter1_reg, ap_block_pp0_stage0_11001, ap_enable_reg_pp0_iter2)
    begin
        if ((not((i_reg_238_pp0_iter1_reg = ap_const_lv4_0)) and not((i_reg_238_pp0_iter1_reg = ap_const_lv4_1)) and not((i_reg_238_pp0_iter1_reg = ap_const_lv4_2)) and not((i_reg_238_pp0_iter1_reg = ap_const_lv4_3)) and not((i_reg_238_pp0_iter1_reg = ap_const_lv4_4)) and not((i_reg_238_pp0_iter1_reg = ap_const_lv4_5)) and not((i_reg_238_pp0_iter1_reg = ap_const_lv4_6)) and not((i_reg_238_pp0_iter1_reg = ap_const_lv4_7)) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (weight_buffer_8_V_full_n = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    weight_cntl_V_write_assign_proc : process(weight_cntl_V_full_n, ap_CS_fsm_state2, exitcond1_fu_280_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (weight_cntl_V_full_n = ap_const_logic_1) and (exitcond1_fu_280_p2 = ap_const_lv1_1))) then 
    ...
    weights_offset_cast_fu_250_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(weights_offset),32));
end behav;
