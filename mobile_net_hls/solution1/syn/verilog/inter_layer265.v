...
wire   [0:0] tmp_473_nbreadreq_fu_120_p3;
wire   [0:0] tmp_474_nbwritereq_fu_128_p3;
wire   [17:0] tmp_113_i_fu_241_p3;
reg   [17:0] tmp_113_i_reg_313;
...
wire    cntl_V_full_n;
reg    cntl_V_write;
wire   [0:0] tmp_475_nbreadreq_fu_136_p3;
...
fifo_w1_d1_A_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x_x cntl_V_fifo_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((tmp_474_nbwritereq_fu_128_p3 == 1'd1) & (tmp_473_nbreadreq_fu_120_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_475_nbreadreq_fu_136_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state5))) begin
...
always @ (*) begin
    if (((tmp_475_nbreadreq_fu_136_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state5) & (cntl_V_empty_n == 1'b1))) begin
        cntl_V_read = 1'b1;
    end else begin
        cntl_V_read = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) | ((tmp_474_nbwritereq_fu_128_p3 == 1'd1) & (tmp_473_nbreadreq_fu_120_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state3)))) begin
        m_axi_betas_ARVALID = grp_conv_4_fu_173_m_axi_betas_ARVALID;
    end else begin
...
always @ (*) begin
    if (((tmp_475_nbreadreq_fu_136_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state5) & (nxt_ready_V_full_n == 1'b1))) begin
...
always @ (*) begin
    if (((tmp_475_nbreadreq_fu_136_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state5) & (pre_ready_V_empty_n == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & ((tmp_474_nbwritereq_fu_128_p3 == 1'd0) | (tmp_473_nbreadreq_fu_120_p3 == 1'd0)))) begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end else begin
...
assign tmp_113_i_fu_241_p3 = ((pingpang_flag_i_reg_161[0:0] === 1'b1) ? 18'd131072 : 18'd0);

assign tmp_473_nbreadreq_fu_120_p3 = pre_ready_V_empty_n;

assign tmp_474_nbwritereq_fu_128_p3 = nxt_ready_V_full_n;

assign tmp_475_nbreadreq_fu_136_p3 = cntl_V_empty_n;

assign tmp_i_fu_232_p3 = ((pingpang_flag_i_reg_161[0:0] === 1'b1) ? 17'd65536 : 17'd0);

always @ (posedge ap_clk) begin
    tmp_i_reg_308[15:0] <= 16'b0000000000000000;
    tmp_113_i_reg_313[16:0] <= 17'b00000000000000000;
end

endmodule //inter_layer265
