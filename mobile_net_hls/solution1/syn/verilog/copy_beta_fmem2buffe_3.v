...
wire   [1:0] i_25_fu_163_p2;
reg    ap_enable_reg_pp0_iter0;
reg   [15:0] tmp_632_reg_194;
...
wire   [31:0] betas_offset_cast_fu_129_p1;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state8)) begin
        i_reg_118 <= 2'd0;
    end else if (((exitcond_fu_158_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        betas_addr_reg_169 <= sum_cast_fu_143_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_reg_185 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((exitcond_reg_185_pp0_iter1_reg == 1'd0) & (beta_buffer_V_full_n == 1'b1) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((exitcond_reg_185 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((exitcond_reg_185 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond_reg_185 == 1'd0) & (m_axi_betas_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((exitcond_reg_185 == 1'd0) & (m_axi_betas_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((exitcond_reg_185 == 1'd0) & (m_axi_betas_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_state10_pp0_stage0_iter1 = ((exitcond_reg_185 == 1'd0) & (m_axi_betas_RVALID == 1'b0));
end
...
assign beta_buffer_V_din = tmp_632_reg_194;

assign beta_cntl_V_din = 1'd0;

assign betas_offset_cast_fu_129_p1 = betas_offset;

assign exitcond_fu_158_p2 = ((i_reg_118 == nLoops) ? 1'b1 : 1'b0);

assign i_25_fu_163_p2 = (i_reg_118 + 2'd1);

assign m_axi_betas_ARADDR = betas_addr_reg_169;
...
assign m_axi_betas_ARLEN = nLoops;
...
assign sum_fu_137_p2 = (tmp_cast_fu_133_p1 + betas_offset_cast_fu_129_p1);

assign tmp_cast_fu_133_p1 = n;

endmodule //copy_beta_fmem2buffe_3
