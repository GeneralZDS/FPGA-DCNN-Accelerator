...
input  [2:0] outputs_offset_c_dout;
...
reg   [0:0] tmp_87_i_i_i_reg_296;
reg    outputs_blk_n_B;
wire    ap_CS_fsm_state12;
reg   [0:0] tmp_85_i_i_i_reg_281;
reg    outputs_offset_blk_n;
reg    outputs_offset_c_blk_n;
reg    cntl_V_blk_n;
wire   [0:0] tmp_277_fu_258_p1;
reg   [30:0] i_0_i_i_i_i_reg_157;
wire   [32:0] outputs_offset_cast_s_fu_168_p1;
reg   [32:0] outputs_offset_cast_s_reg_262;
reg    ap_block_state1;
wire   [33:0] sext_cast_i_i_fu_172_p1;
reg   [33:0] sext_cast_i_i_reg_267;
wire   [31:0] mLoops_fu_198_p3;
reg   [31:0] mLoops_reg_275;
wire    ap_CS_fsm_state3;
wire   [0:0] tmp_nbreadreq_fu_102_p3;
wire   [0:0] tmp_85_i_i_i_fu_206_p2;
wire   [32:0] tmp_39_i_i_fu_216_p2;
reg   [32:0] tmp_39_i_i_reg_285;
reg   [31:0] outputs_addr_reg_290;
wire    ap_CS_fsm_state4;
wire   [0:0] tmp_87_i_i_i_fu_243_p2;
...
wire  signed [31:0] tmp_271_fu_184_p1;
wire  signed [31:0] tmp_84_i_i_i_fu_192_p1;
wire   [0:0] tmp_271_fu_184_p3;
wire   [31:0] tmp_84_i_i_i_fu_192_p2;
wire  signed [31:0] tmp_cast_i_i_fu_212_p0;
wire  signed [32:0] tmp_cast_i_i_fu_212_p1;
wire  signed [33:0] tmp_39_cast_i_i_fu_221_p1;
wire   [33:0] sum_i_i_fu_224_p2;
wire   [31:0] i_0_i_cast_i_i_i_fu_239_p1;
reg   [10:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~(((tmp_277_fu_258_p1 == 1'd0) & (cntl_V_full_n == 1'b0)) | ((m_axi_outputs_BVALID == 1'b0) & (tmp_85_i_i_i_reg_281 == 1'd1))) & (tmp_277_fu_258_p1 == 1'd0) & (1'b1 == ap_CS_fsm_state12))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_87_i_i_i_fu_243_p2 == 1'd1))) begin
        i_0_i_i_i_i_reg_157 <= i_fu_248_p2;
    end else if (((ap_sig_ioackin_m_axi_outputs_AWREADY == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        i_0_i_i_i_i_reg_157 <= 31'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (tmp_nbreadreq_fu_102_p3 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state4)) begin
        outputs_addr_reg_290 <= sum_cast_i_i_fu_229_p1;
    end
end

always @ (posedge ap_clk) begin
    if ((~((outputs_offset_c_empty_n == 1'b0) | (outputs_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        outputs_offset_cast_s_reg_262[2 : 0] <= outputs_offset_cast_s_fu_168_p1[2 : 0];
        sext_cast_i_i_reg_267[30 : 0] <= sext_cast_i_i_fu_172_p1[30 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_87_i_i_i_fu_243_p2 == 1'd1))) begin
        tmp_276_reg_305 <= output_buffer_V_dout;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (tmp_85_i_i_i_fu_206_p2 == 1'd1) & (tmp_nbreadreq_fu_102_p3 == 1'd1))) begin
...
always @ (*) begin
    if ((tmp_87_i_i_i_fu_243_p2 == 1'd0)) begin
...
always @ (*) begin
    if ((~(((tmp_277_fu_258_p1 == 1'd0) & (cntl_V_full_n == 1'b0)) | ((m_axi_outputs_BVALID == 1'b0) & (tmp_85_i_i_i_reg_281 == 1'd1))) & (tmp_277_fu_258_p1 == 1'd0) & (1'b1 == ap_CS_fsm_state12))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((tmp_277_fu_258_p1 == 1'd0) & (1'b1 == ap_CS_fsm_state12))) begin
...
always @ (*) begin
    if ((~(((tmp_277_fu_258_p1 == 1'd0) & (cntl_V_full_n == 1'b0)) | ((m_axi_outputs_BVALID == 1'b0) & (tmp_85_i_i_i_reg_281 == 1'd1))) & (1'b1 == ap_CS_fsm_state12) & (tmp_85_i_i_i_reg_281 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_reg_ioackin_m_axi_outputs_WREADY == 1'b0) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_87_i_i_i_reg_296 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (output_buffer_V_empty_n == 1'b1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_87_i_i_i_fu_243_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (tmp_85_i_i_i_reg_281 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_87_i_i_i_reg_296 == 1'd1) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if ((~(((tmp_277_fu_258_p1 == 1'd0) & (cntl_V_full_n == 1'b0)) | ((m_axi_outputs_BVALID == 1'b0) & (tmp_85_i_i_i_reg_281 == 1'd1))) & (1'b1 == ap_CS_fsm_state12) & (result_buffer_V_empty_n == 1'b1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (result_m_V_empty_n == 1'b1) & (tmp_nbreadreq_fu_102_p3 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (result_n_V_empty_n == 1'b1) & (tmp_nbreadreq_fu_102_p3 == 1'd1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((tmp_85_i_i_i_fu_206_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3) & (tmp_nbreadreq_fu_102_p3 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state12;
            end else if (((1'b1 == ap_CS_fsm_state3) & (tmp_85_i_i_i_fu_206_p2 == 1'd1) & (tmp_nbreadreq_fu_102_p3 == 1'd1))) begin
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((tmp_87_i_i_i_fu_243_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((tmp_87_i_i_i_fu_243_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
        ...
        ap_ST_fsm_state12 : begin
            if ((~(((tmp_277_fu_258_p1 == 1'd0) & (cntl_V_full_n == 1'b0)) | ((m_axi_outputs_BVALID == 1'b0) & (tmp_85_i_i_i_reg_281 == 1'd1))) & (tmp_277_fu_258_p1 == 1'd0) & (1'b1 == ap_CS_fsm_state12))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if ((~(((tmp_277_fu_258_p1 == 1'd0) & (cntl_V_full_n == 1'b0)) | ((m_axi_outputs_BVALID == 1'b0) & (tmp_85_i_i_i_reg_281 == 1'd1))) & (1'b1 == ap_CS_fsm_state12) & (tmp_277_fu_258_p1 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state12;
            end
...
always @ (*) begin
    ap_block_state12 = (((tmp_277_fu_258_p1 == 1'd0) & (cntl_V_full_n == 1'b0)) | ((m_axi_outputs_BVALID == 1'b0) & (tmp_85_i_i_i_reg_281 == 1'd1)));
end

assign ap_block_state6_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state7_io = ((ap_sig_ioackin_m_axi_outputs_WREADY == 1'b0) & (tmp_87_i_i_i_reg_296 == 1'd1));
end

assign ap_block_state7_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_condition_410 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_87_i_i_i_reg_296 == 1'd1));
end
...
assign i_0_i_cast_i_i_i_fu_239_p1 = i_0_i_i_i_i_reg_157;

assign i_fu_248_p2 = (i_0_i_i_i_i_reg_157 + 31'd1);

assign mLoops_fu_198_p3 = ((tmp_271_fu_184_p3[0:0] === 1'b1) ? 32'd4 : tmp_84_i_i_i_fu_192_p2);
...
assign m_axi_outputs_AWADDR = outputs_addr_reg_290;
...
assign m_axi_outputs_AWLEN = mLoops_reg_275;
...
assign m_axi_outputs_WDATA = tmp_276_reg_305;
...
assign outputs_offset_cast_s_fu_168_p1 = outputs_offset_c_dout;

assign sext_cast_i_i_fu_172_p1 = outputs_offset_dout;

assign sum_cast_i_i_fu_229_p1 = $signed(sum_i_i_fu_224_p2);

assign sum_i_i_fu_224_p2 = ($signed(sext_cast_i_i_reg_267) + $signed(tmp_39_cast_i_i_fu_221_p1));

assign tmp_271_fu_184_p1 = result_m_V_dout;

assign tmp_271_fu_184_p3 = tmp_271_fu_184_p1[32'd31];

assign tmp_277_fu_258_p1 = result_buffer_V_dout;

assign tmp_39_cast_i_i_fu_221_p1 = $signed(tmp_39_i_i_reg_285);

assign tmp_39_i_i_fu_216_p2 = ($signed(outputs_offset_cast_s_reg_262) + $signed(tmp_cast_i_i_fu_212_p1));

assign tmp_84_i_i_i_fu_192_p1 = result_m_V_dout;

assign tmp_84_i_i_i_fu_192_p2 = ($signed(32'd4) - $signed(tmp_84_i_i_i_fu_192_p1));

assign tmp_85_i_i_i_fu_206_p2 = (($signed(result_n_V_dout) > $signed(32'd479)) ? 1'b1 : 1'b0);

assign tmp_87_i_i_i_fu_243_p2 = (($signed(i_0_i_cast_i_i_i_fu_239_p1) < $signed(mLoops_reg_275)) ? 1'b1 : 1'b0);

assign tmp_cast_i_i_fu_212_p0 = result_m_V_dout;

assign tmp_cast_i_i_fu_212_p1 = tmp_cast_i_i_fu_212_p0;

assign tmp_nbreadreq_fu_102_p3 = result_buffer_V_empty_n;

always @ (posedge ap_clk) begin
    outputs_offset_cast_s_reg_262[32:3] <= 30'b000000000000000000000000000000;
    sext_cast_i_i_reg_267[33:31] <= 3'b000;
end

endmodule //output_result_1
