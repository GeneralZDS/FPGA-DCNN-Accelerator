...
wire   [13:0] base_addr_fu_381_p2;
wire   [5:0] tmp_545_fu_387_p1;
reg   [5:0] tmp_545_reg_467;
wire   [1:0] tn_5_fu_396_p2;
reg   [1:0] tn_5_reg_475;
wire    ap_CS_fsm_state2;
wire   [4:0] tm_1_fu_411_p2;
reg   [4:0] tm_1_reg_483;
wire    ap_CS_fsm_state3;
wire   [3:0] tmp_546_fu_421_p1;
reg   [3:0] tmp_546_reg_488;
wire   [0:0] tmp_7_fu_406_p2;
reg   [31:0] weights_addr_reg_492;
wire   [13:0] base_addr_d1_14_fu_440_p2;
reg   [15:0] tmp_547_reg_503;
wire   [13:0] base_addr_d2_9_fu_446_p2;
wire    ap_CS_fsm_state12;
reg   [13:0] base_addr_d2_reg_314;
reg   [1:0] tn_reg_324;
reg   [13:0] base_addr_d_reg_335;
...
wire   [5:0] tmp_544_fu_361_p1;
wire   [12:0] tmp_fu_365_p3;
wire   [13:0] m_cast_fu_377_p1;
wire   [13:0] tmp_cast3_fu_373_p1;
wire   [5:0] tm_cast_cast_fu_402_p1;
wire   [31:0] tmp_135_cast_fu_417_p1;
...
always @ (posedge ap_clk) begin
    if (((tmp_7_fu_406_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (tmp_7_fu_406_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((tmp_546_reg_488 == 4'd0) & (weight_buffer_0_V_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state12))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (weight_buffer_10_V_full_n == 1'b1) & (tmp_546_reg_488 == 4'd10))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (weight_buffer_11_V_full_n == 1'b1) & (tmp_546_reg_488 == 4'd11))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (weight_buffer_12_V_full_n == 1'b1) & (tmp_546_reg_488 == 4'd12))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (weight_buffer_13_V_full_n == 1'b1) & (tmp_546_reg_488 == 4'd13))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (weight_buffer_14_V_full_n == 1'b1) & (tmp_546_reg_488 == 4'd14))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (weight_buffer_15_V_full_n == 1'b1) & (tmp_546_reg_488 == 4'd15))) begin
...
always @ (*) begin
    if (((weight_buffer_1_V_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state12) & (tmp_546_reg_488 == 4'd1))) begin
...
always @ (*) begin
    if (((weight_buffer_2_V_full_n == 1'b1) & (1'b1 == ap_CS_fsm_state12) & (tmp_546_reg_488 == 4'd2))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (weight_buffer_3_V_full_n == 1'b1) & (tmp_546_reg_488 == 4'd3))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (weight_buffer_4_V_full_n == 1'b1) & (tmp_546_reg_488 == 4'd4))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (weight_buffer_5_V_full_n == 1'b1) & (tmp_546_reg_488 == 4'd5))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (weight_buffer_6_V_full_n == 1'b1) & (tmp_546_reg_488 == 4'd6))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (weight_buffer_7_V_full_n == 1'b1) & (tmp_546_reg_488 == 4'd7))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (weight_buffer_8_V_full_n == 1'b1) & (tmp_546_reg_488 == 4'd8))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state12) & (weight_buffer_9_V_full_n == 1'b1) & (tmp_546_reg_488 == 4'd9))) begin
...
assign base_addr_d1_14_fu_440_p2 = (base_addr_d2_reg_314 + 14'd128);

assign base_addr_d2_9_fu_446_p2 = (base_addr_d_reg_335 + 14'd1);
...
assign sum_fu_425_p2 = (weights_offset_cast_reg_457 + tmp_135_cast_fu_417_p1);

assign tm_1_fu_411_p2 = (tm_reg_346 + 5'd1);

assign tm_cast_cast_fu_402_p1 = tm_reg_346;

assign tmp_135_cast_fu_417_p1 = base_addr_d_reg_335;

assign tmp_544_fu_361_p1 = n[5:0];

assign tmp_545_fu_387_p1 = mLoops[5:0];

assign tmp_546_fu_421_p1 = tm_reg_346[3:0];

assign tmp_7_fu_406_p2 = (($signed(tm_cast_cast_fu_402_p1) < $signed(tmp_545_reg_467)) ? 1'b1 : 1'b0);

assign tmp_cast3_fu_373_p1 = tmp_fu_365_p3;

assign tmp_fu_365_p3 = {{tmp_544_fu_361_p1}, {7'd0}};

assign tn_5_fu_396_p2 = (tn_reg_324 + 2'd1);

assign weight_buffer_0_V_din = tmp_547_reg_503;

assign weight_buffer_10_V_din = tmp_547_reg_503;

assign weight_buffer_11_V_din = tmp_547_reg_503;

assign weight_buffer_12_V_din = tmp_547_reg_503;

assign weight_buffer_13_V_din = tmp_547_reg_503;

assign weight_buffer_14_V_din = tmp_547_reg_503;

assign weight_buffer_15_V_din = tmp_547_reg_503;

assign weight_buffer_1_V_din = tmp_547_reg_503;

assign weight_buffer_2_V_din = tmp_547_reg_503;

assign weight_buffer_3_V_din = tmp_547_reg_503;

assign weight_buffer_4_V_din = tmp_547_reg_503;

assign weight_buffer_5_V_din = tmp_547_reg_503;

assign weight_buffer_6_V_din = tmp_547_reg_503;

assign weight_buffer_7_V_din = tmp_547_reg_503;

assign weight_buffer_8_V_din = tmp_547_reg_503;

assign weight_buffer_9_V_din = tmp_547_reg_503;
...
endmodule //copy_weight_fmem2buf_5
